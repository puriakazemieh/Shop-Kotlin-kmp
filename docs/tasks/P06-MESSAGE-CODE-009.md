# P06-MESSAGE-CODE-009 — template engine با variable allowlist و RTL preview
...
- Depends on: P06-SECURITY-SEC-008
- Blocks: P06-MESSAGE-CODE-010
- Requirement source: Master checklist row P06-MESSAGE-CODE-009 و Source audit بخش MESSAGE

## هدف قابل اندازه‌گیری
template engine با variable allowlist و RTL preview

## خروجی مورد انتظار
eval/PHP template صفر؛ HTML sanitised
...
- Dependencyها: P06-SECURITY-SEC-008
...
- معیار اختصاصی: eval/PHP template صفر؛ HTML sanitised
...
- انتظار: eval/PHP template صفر؛ HTML sanitised
...
## Evidence
- مسیر: docs/evidence/P06-MESSAGE-CODE-009/
...
## Completion record
- Started at: 2026-09-07T16:45:15
- Completed at: 2026-09-07T16:45:59
- Changed files: wordpress/carmilla-bridge/includes/class-cb-template-engine.php, wordpress/carmilla-bridge/includes/class-cb-standalone-boot.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P06-MESSAGE-CODE-009/summary.md
