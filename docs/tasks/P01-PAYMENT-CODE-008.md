# P01-PAYMENT-CODE-008 — پاک‌شدن cart فقط بعد از verify authoritative موفق انجام شود
...
- Status: TODO
- Phase/Area/Type: P01 / PAYMENT / CODE
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P01-PAYMENT-CODE-007
- Blocks: P01-PAYMENT-CODE-009
- Requirement source: Master checklist row P01-PAYMENT-CODE-008 و Source audit بخش PAYMENT

## هدف قابل اندازه‌گیری
پاک‌شدن cart فقط بعد از verify authoritative موفق انجام شود

## Threat/Exploit Surface
- از دست رفتن سبد خرید کاربر در صورت بروز خطا در درگاه پرداخت یا Verify ناموفق، که منجر به کاهش نرخ تبدیل می‌شود.
- پاک شدن سبد با وضعیت جعلی "موفق" بدون اینکه پولی جابجا شده باشد.

## خروجی مورد انتظار
fail/cancel/timeout cart را حفظ کنند؛ retry duplicate نسازد
...
- Dependencyها: P01-PAYMENT-CODE-007
...
- معیار اختصاصی: fail/cancel/timeout cart را حفظ کنند؛ retry duplicate نسازد
...
- انتظار: fail/cancel/timeout cart را حفظ کنند؛ retry duplicate نسازد
...
## Evidence
- مسیر: docs/evidence/P01-PAYMENT-CODE-008/
...
## Completion record
- Started at: 2026-08-25T14:33:00
- Completed at: 2026-08-25T14:35:00
- Changed files: `CheckoutViewModel.kt`
...
- Evidence paths: `docs/evidence/P01-PAYMENT-CODE-008/EVIDENCE.md`
