# P02-CI-OPS-016 — release artifact workflow از debug build جدا شود
...
- Status: TODO
- Phase/Area/Type: P02 / CI / OPS
- Priority/Risk/Size: P1/MEDIUM / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH
- Depends on: P02-CORE-CODE-015
- Blocks: P02-QA-MANUAL-017
- Requirement source: Master checklist row P02-CI-OPS-016 و Source audit بخش CI

## هدف قابل اندازه‌گیری
release artifact workflow از debug build جدا شود

## خروجی مورد انتظار
artifact دارای version/checksum/SBOM و retention
...
- Dependencyها: P02-CORE-CODE-015
...
- معیار اختصاصی: artifact دارای version/checksum/SBOM و retention
...
- انتظار: artifact دارای version/checksum/SBOM و retention
...
## Evidence
- مسیر: docs/evidence/P02-CI-OPS-016/
