# P13-LMS-DATA-004 — schema/migration برای Quiz،Question،Attempt،Certificate
...
- Depends on: P13-LMS-DATA-003
- Blocks: P13-LMS-SEC-005
- Requirement source: Master checklist row P13-LMS-DATA-004 و Source audit بخش LMS

## هدف قابل اندازه‌گیری
schema/migration برای Quiz،Question،Attempt،Certificate

## خروجی مورد انتظار
versioning سؤال و attempt قابل بازتولید باشد
...
- معیار اختصاصی: versioning سؤال و attempt قابل بازتولید باشد
...
- انتظار: versioning سؤال و attempt قابل بازتولید باشد
...
## Evidence
- مسیر: docs/evidence/P13-LMS-DATA-004/
