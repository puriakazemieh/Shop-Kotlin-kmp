# P11-ANDROID-CODE-003 — name/icon/splash/color/applicationId/version از BuildIdentity
...
- Depends on: P11-ANDROID-CODE-002
- Blocks: P11-ANDROID-SEC-004
- Requirement source: Master checklist row P11-ANDROID-CODE-003 و Source audit بخش ANDROID

## هدف قابل اندازه‌گیری
name/icon/splash/color/applicationId/version از BuildIdentity

## خروجی مورد انتظار
resource validation؛ collision صفر
...
- Dependencyها: P11-ANDROID-CODE-002
...
- معیار اختصاصی: resource validation؛ collision صفر
...
- انتظار: resource validation؛ collision صفر
...
## Evidence
- مسیر: docs/evidence/P11-ANDROID-CODE-003/
