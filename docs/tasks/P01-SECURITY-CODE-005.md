# P01-SECURITY-CODE-005 — token storage پلتفرم‌ها امن‌تر و Bearer فقط به host مجاز ارسال شود
...
- Blocks: P01-SECURITY-CODE-006
- Requirement source: Master checklist row P01-SECURITY-CODE-005 و Source audit بخش SECURITY
...
- Dependencyها: P01-SECURITY-CODE-004
...
- معیار اختصاصی: foreign host test فاقد header؛ logout/expiry/rotation test
...
- انتظار: foreign host test فاقد header؛ logout/expiry/rotation test
...
## Evidence
- مسیر: docs/evidence/P01-SECURITY-CODE-005/
