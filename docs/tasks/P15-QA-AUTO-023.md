# P15-QA-AUTO-023 — load، soak، race و failure-injection سرور مستقل
...
- Depends on: P15-QA-AUTO-022
- Blocks: P15-SECURITY-SEC-024
- Requirement source: Master checklist row P15-QA-AUTO-023 و Source audit بخش QA
...
load/soak/race و failure-injection را در staging ایزوله Spring با tenantهای synthetic و capabilityهای SKU منتخب اجرا کن؛ خروجی artifact سرور مشخص باشد.

## خروجی مورد انتظار
دوباره‌کاری مالی/رزرو و نشت tenant صفر؛ recovery/SLO مستند؛ test/bootJar baseline مربوط ShopServer/Shop باشد.
...
3. تغییر محدود این کارت را در مسیرهای مجاز پیاده یا آزمون کن: load/soak/race و failure-injection را در staging ایزوله Spring با tenantهای synthetic و capabilityهای SKU منتخب اجرا کن؛ خروجی artifact سرور مشخص باشد.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: دوباره‌کاری مالی/رزرو و نشت tenant صفر؛ recovery/SLO مستند؛ test/bootJar baseline مربوط ShopServer/Shop باشد.
...
- معیار اختصاصی: دوباره‌کاری مالی/رزرو و نشت tenant صفر؛ recovery/SLO مستند؛ test/bootJar baseline مربوط ShopServer/Shop باشد.
...
- معیار موفقیت: دوباره‌کاری مالی/رزرو و نشت tenant صفر؛ recovery/SLO مستند؛ test/bootJar baseline مربوط ShopServer/Shop باشد.
...
## Evidence
- مسیر: docs/evidence/P15-QA-AUTO-023/
