# P15-QA-AUTO-023 — load/soak/race و failure-injection
...
load/soak/race و failure-injection

## خروجی مورد انتظار
SLO و ظرفیت با dataset نماینده
...
- معیار اختصاصی: SLO و ظرفیت با dataset نماینده
...
- انتظار: SLO و ظرفیت با dataset نماینده
