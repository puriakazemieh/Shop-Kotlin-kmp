# P14-CLINIC-SEC-004 — نقش/رابطه مراجع،مشاور،پذیرش،ناظر و مدیر
...
- Status: TODO
- Phase/Area/Type: P14 / CLINIC / SEC
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P14-CLINIC-PRIVACY-003
- Blocks: P14-CLINIC-DATA-005
- Requirement source: Master checklist row P14-CLINIC-SEC-004 و Source audit بخش CLINIC

## هدف قابل اندازه‌گیری
نقش/رابطه مراجع،مشاور،پذیرش،ناظر و مدیر

## خروجی مورد انتظار
RBAC + relationship-based access + deny-by-default
...
- Dependencyها: P14-CLINIC-PRIVACY-003
...
- معیار اختصاصی: RBAC + relationship-based access + deny-by-default
...
- انتظار: RBAC + relationship-based access + deny-by-default
...
## Evidence
- مسیر: docs/evidence/P14-CLINIC-SEC-004/
