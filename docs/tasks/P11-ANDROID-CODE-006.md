# P11-ANDROID-CODE-006 — verified App Links و opaque payment result
...
- Depends on: P11-ANDROID-CODE-005
- Blocks: P11-ANDROID-SEC-007
- Requirement source: Master checklist row P11-ANDROID-CODE-006 و Source audit بخش ANDROID

## هدف قابل اندازه‌گیری
verified App Links و opaque payment result

## خروجی مورد انتظار
cold/warm/killed؛ server polling
...
- Dependencyها: P11-ANDROID-CODE-005
...
- معیار اختصاصی: cold/warm/killed؛ server polling
...
- انتظار: cold/warm/killed؛ server polling
...
## Evidence
- مسیر: docs/evidence/P11-ANDROID-CODE-006/
