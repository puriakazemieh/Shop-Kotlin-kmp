# P15-SPRING-OPS-020 — container non-root،pinned base،SBOM و image scan
...
- Depends on: P15-SPRING-OPS-019
- Blocks: P15-SPRING-OPS-021
- Requirement source: Master checklist row P15-SPRING-OPS-020 و Source audit بخش SPRING

## هدف قابل اندازه‌گیری
container non-root،pinned base،SBOM و image scan

## خروجی مورد انتظار
critical CVE و mutable tag صفر
...
- Dependencyها: P15-SPRING-OPS-019
...
- معیار اختصاصی: critical CVE و mutable tag صفر
...
- انتظار: critical CVE و mutable tag صفر
...
## Evidence
- مسیر: docs/evidence/P15-SPRING-OPS-020/
