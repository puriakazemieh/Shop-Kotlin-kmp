# P01-WPPLUGIN-SEC-018 — LMS/Clinic/Psych پیش‌فرض خاموش و endpoint/media/job آن‌ها fail-closed شود؛ entitlement کامل به فازهای ۱۳/۱۴ موکول شود
...
- Depends on: P01-PAYMENT-SEC-017
- Blocks: P01-SECURITY-CODE-019
- Requirement source: Master checklist row P01-WPPLUGIN-SEC-018 و Source audit بخش WPPLUGIN
...
- Dependencyها: P01-PAYMENT-SEC-017
...
- معیار اختصاصی: با toggle خاموش URL مستقیم/API discovery دسترسی ندهد
...
- انتظار: با toggle خاموش URL مستقیم/API discovery دسترسی ندهد
...
## Evidence
- مسیر: docs/evidence/P01-WPPLUGIN-SEC-018/
