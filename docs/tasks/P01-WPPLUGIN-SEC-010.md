# P01-WPPLUGIN-SEC-010 — JWT secret/default، issuer/audience/expiry/rotation/revocation اصلاح شود
...
- Status: TODO
- Phase/Area/Type: P01 / WPPLUGIN / SEC
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH
- Depends on: P01-PAYMENT-CODE-009
- Blocks: P01-WPPLUGIN-SEC-011
- Requirement source: Master checklist row P01-WPPLUGIN-SEC-010 و Source audit بخش WPPLUGIN
...
- Dependencyها: P01-PAYMENT-CODE-009
...
- معیار اختصاصی: tamper/expired/wrong audience/revoked token رد شوند
...
- انتظار: tamper/expired/wrong audience/revoked token رد شوند
...
## Evidence
- مسیر: docs/evidence/P01-WPPLUGIN-SEC-010/
...
## Completion record
- Started at: 2026-08-25T14:42:00
- Completed at: 2026-08-25T14:48:00
- Changed files: `class-cb-jwt.php`, `class-cb-auth-controller.php`, `smoke.php`
- Commands and exit codes: `docker run --rm -v ${PWD}:/app -w /app php:8.1-cli php wordpress/carmilla-bridge/tests/smoke.php` (Exit code 0)
- Manual tester/date/result: AI (Tested JWT revocation logic via PHP tests)
- Evidence paths: `docs/evidence/P01-WPPLUGIN-SEC-010/EVIDENCE.md`
