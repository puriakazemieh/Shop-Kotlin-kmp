# P03-MANIFEST-CODE-011 — bootstrap state و source precedence: فایل generated/local قابل ویرایش برای هر app، سپس manifest معتبر tenant؛ قبل از NavHost و با last-known-good م...
...
- Requirement source: Master checklist row P03-MANIFEST-CODE-011 و Source audit بخش MANIFEST

## هدف قابل اندازه‌گیری
bootstrap state و source precedence: فایل generated/local قابل ویرایش برای هر app، سپس manifest معتبر tenant؛ قبل از NavHost و با last-known-good محدود

## خروجی مورد انتظار
چهار boolean اصلی بدون تغییر source پراکنده قابل تنظیم؛ invalid/remote-over-ceiling fail-closed؛ retry/error UX
...
- Dependencyها: P03-WPPLUGIN-CODE-010
...
- معیار اختصاصی: چهار boolean اصلی بدون تغییر source پراکنده قابل تنظیم؛ invalid/remote-over-ceiling fail-closed؛ retry/error UX
...
- انتظار: چهار boolean اصلی بدون تغییر source پراکنده قابل تنظیم؛ invalid/remote-over-ceiling fail-closed؛ retry/error UX
...
## Evidence
- مسیر: docs/evidence/P03-MANIFEST-CODE-011/
