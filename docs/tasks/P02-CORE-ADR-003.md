# P02-CORE-ADR-003 — scope convention plugin و pluginهای مجاز تصویب شود
...
- Depends on: P02-CORE-CODE-002
- Blocks: P02-CORE-CODE-004
- Requirement source: Master checklist row P02-CORE-ADR-003 و Source audit بخش CORE

## هدف قابل اندازه‌گیری
scope convention plugin و pluginهای مجاز تصویب شود

## خروجی مورد انتظار
از استخراج تمام config در یک Task جلوگیری شود
...
- Dependencyها: P02-CORE-CODE-002
...
- معیار اختصاصی: از استخراج تمام config در یک Task جلوگیری شود
...
- انتظار: از استخراج تمام config در یک Task جلوگیری شود
...
## Evidence
- مسیر: docs/evidence/P02-CORE-ADR-003/
