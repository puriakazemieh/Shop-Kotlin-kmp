# P00-PROGRAM-DISC-002 — inventory همه applicationId/bundleId، signing key owner، store track، domain و artifact قبلی
...
- Blocks: P00-PROGRAM-ADR-003
- Requirement source: Master checklist row P00-PROGRAM-DISC-002 و Source audit بخش PROGRAM

## هدف قابل اندازه‌گیری
inventory همه applicationId/bundleId، signing key owner، store track، domain و artifact قبلی

## خروجی مورد انتظار
جدول امضاشده انسانی؛ موارد نامعلوم `UNKNOWN` بمانند، حدس زده نشوند
...
- Dependencyها: P00-PROGRAM-DISC-001
...
- معیار اختصاصی: جدول امضاشده انسانی؛ موارد نامعلوم `UNKNOWN` بمانند، حدس زده نشوند
...
- انتظار: جدول امضاشده انسانی؛ موارد نامعلوم `UNKNOWN` بمانند، حدس زده نشوند
...
## Evidence
- مسیر: docs/evidence/P00-PROGRAM-DISC-002/
