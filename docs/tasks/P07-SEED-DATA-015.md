# P07-SEED-DATA-015 — `all-fa-v1` composition، نه duplicate copy
...
- Depends on: P07-SEED-DATA-014
- Blocks: P07-MIGRATION-ADR-016
- Requirement source: Master checklist row P07-SEED-DATA-015 و Source audit بخش SEED

## هدف قابل اندازه‌گیری
`all-fa-v1` composition، نه duplicate copy

## خروجی مورد انتظار
dependency resolver packها را یک‌بار اعمال کند
...
- Dependencyها: P07-SEED-DATA-014
...
- معیار اختصاصی: dependency resolver packها را یک‌بار اعمال کند
...
- انتظار: dependency resolver packها را یک‌بار اعمال کند
...
## Evidence
- مسیر: docs/evidence/P07-SEED-DATA-015/
...
## Completion record
- Started at: 2026-09-08T10:06:18
- Completed at: 2026-09-08T10:07:25
- Changed files: wordpress/packages/carmilla-core/inc/Import/Carmilla_Importer.php, wordpress/carmilla-bridge/seeds/all-fa-v1.json
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: AWAITING_MANUAL_QA
- Evidence paths: docs/evidence/P07-SEED-DATA-015/summary.md
