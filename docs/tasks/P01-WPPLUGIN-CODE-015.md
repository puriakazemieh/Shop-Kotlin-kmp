# P01-WPPLUGIN-CODE-015 — Wallet/session-credit خارج Scope shop-only از route/job/API production غیرفعال و fail-closed شود؛ فقط اگر legacy فعال/فروخته شده است ledger/transac...
...
- Depends on: P01-WPPLUGIN-SEC-014
- Blocks: P01-WPPLUGIN-CODE-016
- Requirement source: Master checklist row P01-WPPLUGIN-CODE-015 و Source audit بخش WPPLUGIN
...
- Dependencyها: P01-WPPLUGIN-SEC-014
...
- معیار اختصاصی: feature خاموش دسترسی صفر؛ در حالت legacy concurrency test و موجودی منفی/credit تکراری صفر
...
- انتظار: feature خاموش دسترسی صفر؛ در حالت legacy concurrency test و موجودی منفی/credit تکراری صفر
...
## Evidence
- مسیر: docs/evidence/P01-WPPLUGIN-CODE-015/
