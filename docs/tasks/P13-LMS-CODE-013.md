# P13-LMS-CODE-013 — assignment/project و upload در صورت تأیید Scope
...
- Depends on: P13-LMS-SEC-012
- Blocks: P13-LMS-CODE-014
- Requirement source: Master checklist row P13-LMS-CODE-013 و Source audit بخش LMS

## هدف قابل اندازه‌گیری
assignment/project و upload در صورت تأیید Scope

## خروجی مورد انتظار
MIME/size/permission/virus policy تست شود
...
- معیار اختصاصی: MIME/size/permission/virus policy تست شود
...
- انتظار: MIME/size/permission/virus policy تست شود
...
## Evidence
- مسیر: docs/evidence/P13-LMS-CODE-013/
