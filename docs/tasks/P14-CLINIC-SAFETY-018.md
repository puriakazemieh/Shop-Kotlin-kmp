# P14-CLINIC-SAFETY-018 — crisis/emergency flow و محدودیت خدمت
...
- Status: TODO
- Phase/Area/Type: P14 / CLINIC / SAFETY
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: HUMAN/EXTERNAL
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P14-CLINIC-CODE-017
- Blocks: P14-MESSAGE-SEC-019
- Requirement source: Master checklist row P14-CLINIC-SAFETY-018 و Source audit بخش CLINIC

## هدف قابل اندازه‌گیری
crisis/emergency flow و محدودیت خدمت

## خروجی مورد انتظار
متن/مسیر ارجاع محلی و عدم اتکای صرف به اپ
...
- Dependencyها: P14-CLINIC-CODE-017
...
- معیار اختصاصی: متن/مسیر ارجاع محلی و عدم اتکای صرف به اپ
...
- انتظار: متن/مسیر ارجاع محلی و عدم اتکای صرف به اپ
...
## Evidence
- مسیر: docs/evidence/P14-CLINIC-SAFETY-018/
