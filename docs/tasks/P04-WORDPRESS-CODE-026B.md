...
# P04-WORDPRESS-CODE-026B — انتقال سبد و سفارش به مسیر مشترک Woo
...
- Depends on: P04-WORDPRESS-CODE-026A
...
فقط cart/order/account adapter و فراخوانی UI دو میزبان را همگرا کن؛ تغییر موتور پرداخت در این کارت نیست و integration رسمی Woo باقی بماند.
...
- مستندات قرارداد مرتبط و `docs/evidence/P04-WORDPRESS-CODE-026B/**`؛ row/card/checklist همین Task.
...
سبد و سفارش synthetic شناسه/مبلغ یکسان؛ HPOS CRUD؛ یک write/callback؛ capability خاموش مسیر جدید را ببندد.
...
- موفقیت: سبد و سفارش synthetic شناسه/مبلغ یکسان؛ HPOS CRUD؛ یک write/callback؛ capability خاموش مسیر جدید را ببندد.
...
- مسیر: `docs/evidence/P04-WORDPRESS-CODE-026B/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
