# P09-QA-MANUAL-003 — clean install/upgrade/rollback روی WP/PHP/Woo matrix
...
- Depends on: P09-QA-AUTO-002
- Blocks: P09-QA-MANUAL-004
- Requirement source: Master checklist row P09-QA-MANUAL-003 و Source audit بخش QA

## هدف قابل اندازه‌گیری
clean install/upgrade/rollback روی WP/PHP/Woo matrix

## خروجی مورد انتظار
minimum/current/mid + HPOS/Blocks
...
- معیار اختصاصی: minimum/current/mid + HPOS/Blocks
...
- انتظار: minimum/current/mid + HPOS/Blocks
...
## Evidence
- مسیر: docs/evidence/P09-QA-MANUAL-003/
...
- Changed files: docs/evidence/P09-QA-MANUAL-003/summary.md
- Commands and exit codes: N/A
- Manual tester/date/result: Pending Human QA / 2026-09-06 / AWAITING_MANUAL_QA
- Evidence paths: docs/evidence/P09-QA-MANUAL-003/summary.md
