...
# P04-WORDPRESS-CODE-026A — انتقال کاتالوگ و محصول به adapter مشترک Woo
...
- Blocks: P04-WORDPRESS-CODE-026B
...
فقط category/product/search/media mapping را از hostها به adapter مشترک WooCommerce منتقل کن؛ UI نمایش پایه هر دو میزبان از همین سرویس استفاده کند.
...
- مستندات قرارداد مرتبط و `docs/evidence/P04-WORDPRESS-CODE-026A/**`؛ row/card/checklist همین Task.
...
شناسه محصول ثابت؛ list/detail در Theme-only/Plugin-only/both همسان؛ بدون Woo پیام پیش‌نیاز و بدون fatal.
...
- موفقیت: شناسه محصول ثابت؛ list/detail در Theme-only/Plugin-only/both همسان؛ بدون Woo پیام پیش‌نیاز و بدون fatal.
...
- مسیر: `docs/evidence/P04-WORDPRESS-CODE-026A/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
