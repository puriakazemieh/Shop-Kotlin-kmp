# P06-MESSAGE-CODE-005 — Generic SMS HTTP adapter با method/auth/header/body mapping
...
- Phase/Area/Type: P06 / MESSAGE / CODE
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH
- Depends on: P06-MESSAGE-CODE-004
- Blocks: P06-MESSAGE-CODE-006
- Requirement source: Master checklist row P06-MESSAGE-CODE-005 و Source audit بخش MESSAGE

## هدف قابل اندازه‌گیری
Generic SMS HTTP adapter با method/auth/header/body mapping

## خروجی مورد انتظار
API key masked؛ success code/message ID configurable
...
- Dependencyها: P06-MESSAGE-CODE-004
...
- معیار اختصاصی: API key masked؛ success code/message ID configurable
...
- انتظار: API key masked؛ success code/message ID configurable
...
## Evidence
- مسیر: docs/evidence/P06-MESSAGE-CODE-005/
...
## Completion record
- Started at: 2026-09-07T16:30:34
- Completed at: 2026-09-07T16:31:10
- Changed files: wordpress/carmilla-bridge/includes/class-cb-sms-http-adapter.php, wordpress/carmilla-bridge/includes/class-cb-standalone-boot.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P06-MESSAGE-CODE-005/summary.md
