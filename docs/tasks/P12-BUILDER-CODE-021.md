...
# P12-BUILDER-CODE-021 — runner واقعی Android از template انتشار
...
- Depends on: P12-BUILDER-CODE-020, P11-ANDROID-GATE-021, P12-BUILDER-SEC-007
- Blocks: P12-BUILDER-OPS-009, P12-QA-MANUAL-022
...
adapter ساخت APK/AAB از androidApp و BuildSpec روی runner ایزوله با vault reference بساز؛ pipeline debug یا مسیر قدیمی composeApp artifact مرجع تحویل نباشد.
...
- مستندات قرارداد مرتبط و `docs/evidence/P12-BUILDER-CODE-021/**`؛ row/card/checklist همین Task.
...
خروجی امضاشده نصب/ارتقا؛ applicationId/نسخه/brand/ceiling درست؛ secret در WP/log/artifact نیست؛ failed build موفق گزارش نشود.
...
- موفقیت: خروجی امضاشده نصب/ارتقا؛ applicationId/نسخه/brand/ceiling درست؛ secret در WP/log/artifact نیست؛ failed build موفق گزارش نشود.
...
- مسیر: `docs/evidence/P12-BUILDER-CODE-021/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
