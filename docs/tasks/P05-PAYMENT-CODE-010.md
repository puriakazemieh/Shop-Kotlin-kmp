# P05-PAYMENT-CODE-010 — `ZarinPalProvider` بر اساس مستند جاری
...
- Depends on: P05-PAYMENT-CODE-009
- Blocks: P05-PAYMENT-CODE-011
- Requirement source: Master checklist row P05-PAYMENT-CODE-010 و Source audit بخش PAYMENT

## هدف قابل اندازه‌گیری
`ZarinPalProvider` بر اساس مستند جاری

## خروجی مورد انتظار
request/startPay/verify/inquiry؛ amount/currency match
...
- Dependencyها: P05-PAYMENT-CODE-009
...
- معیار اختصاصی: request/startPay/verify/inquiry؛ amount/currency match
...
- انتظار: request/startPay/verify/inquiry؛ amount/currency match
...
## Evidence
- مسیر: docs/evidence/P05-PAYMENT-CODE-010/
