# P13-LMS-DISC-001 — Scope نسخه اول: course/lesson/quiz/certificate؛ ثبت non-goalها
...
Scope نسخه اول: course/lesson/quiz/certificate؛ ثبت non-goalها

## خروجی مورد انتظار
Product brief و سناریوهای پولی/رایگان تأیید شود
...
- معیار اختصاصی: Product brief و سناریوهای پولی/رایگان تأیید شود
...
- انتظار: Product brief و سناریوهای پولی/رایگان تأیید شود
...
## Evidence
- مسیر: docs/evidence/P13-LMS-DISC-001/
