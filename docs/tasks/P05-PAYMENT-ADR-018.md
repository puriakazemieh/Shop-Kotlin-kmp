# P05-PAYMENT-ADR-018 — PSP مستقیم اول و شرایط terminal مشتری انتخاب شود
...
- Depends on: P05-PAYMENT-CODE-017
- Blocks: P05-PAYMENT-CODE-019
- Requirement source: Master checklist row P05-PAYMENT-ADR-018 و Source audit بخش PAYMENT

## هدف قابل اندازه‌گیری
PSP مستقیم اول و شرایط terminal مشتری انتخاب شود

## خروجی مورد انتظار
SEP/PEC یا PSP دیگر بر مبنای قرارداد جاری
...
- Dependencyها: P05-PAYMENT-CODE-017
...
- معیار اختصاصی: SEP/PEC یا PSP دیگر بر مبنای قرارداد جاری
...
- انتظار: SEP/PEC یا PSP دیگر بر مبنای قرارداد جاری
...
## Evidence
- مسیر: docs/evidence/P05-PAYMENT-ADR-018/
