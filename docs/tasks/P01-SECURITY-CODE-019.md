# P01-SECURITY-CODE-019 — hardcoded/demo secret و credential پیش‌فرض از artifactها حذف شوند
...
- Depends on: P01-WPPLUGIN-SEC-018
- Blocks: P01-QA-AUTO-020
- Requirement source: Master checklist row P01-SECURITY-CODE-019 و Source audit بخش SECURITY
...
- Dependencyها: P01-WPPLUGIN-SEC-018
...
- معیار اختصاصی: secret scan؛ production بدون secret لازم fail-closed
...
- انتظار: secret scan؛ production بدون secret لازم fail-closed
...
## Evidence
- مسیر: docs/evidence/P01-SECURITY-CODE-019/
