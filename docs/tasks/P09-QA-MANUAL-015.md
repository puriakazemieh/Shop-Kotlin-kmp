# P09-QA-MANUAL-015 — expanded beta فقط پس از Gate cohort اول
...
expanded beta فقط پس از Gate cohort اول

## خروجی مورد انتظار
۸–۱۲ مشتری؛ top blockerها رفع
...
- Dependencyها: P09-OBSERVABILITY-BIZ-014
...
- معیار اختصاصی: ۸–۱۲ مشتری؛ top blockerها رفع
...
- انتظار: ۸–۱۲ مشتری؛ top blockerها رفع
...
## Evidence
- مسیر: docs/evidence/P09-QA-MANUAL-015/
