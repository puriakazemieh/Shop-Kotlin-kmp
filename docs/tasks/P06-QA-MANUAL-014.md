# P06-QA-MANUAL-014 — SMS/Email sandbox واقعی برای هر preset
...
SMS/Email sandbox واقعی برای هر preset

## خروجی مورد انتظار
recipient تست، tester/date/provider ID redacted
...
- معیار اختصاصی: recipient تست، tester/date/provider ID redacted
...
- انتظار: recipient تست، tester/date/provider ID redacted
