# P14-CLINIC-DATA-005 — مدل/مهاجرت practitioner،availability،appointment
...
مدل/مهاجرت practitioner،availability،appointment

## خروجی مورد انتظار
migration/constraints/timezone tests
...
- معیار اختصاصی: migration/constraints/timezone tests
...
- انتظار: migration/constraints/timezone tests
