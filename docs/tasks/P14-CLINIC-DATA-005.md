# P14-CLINIC-DATA-005 — مدل نوبت‌دهی مشترک با حفظ هویت و تفکیک SKU
...
- Status: TODO
- Phase/Area/Type: P14 / CLINIC / DATA
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: AI
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P14-CLINIC-SEC-004
- Blocks: P14-CLINIC-CODE-033
- Requirement source: Master checklist row P14-CLINIC-DATA-005 و Source audit بخش CLINIC
...
practitioner/availability/appointment و migration/constraints/timezone در kernel هر دو ZIP از یک schema authority ارائه شوند؛ نیازمندی note/psych بی‌دلیل به رزرو پایه وارد نشود.

## خروجی مورد انتظار
clean/upgrade و جابه‌جایی میزبان شناسه را حفظ کند؛ booking-only بدون جداول/endpointهای غیرمجاز دیگر قابل استفاده باشد.
...
- Dependencyها: P14-CLINIC-SEC-004
...
3. تغییر محدود این کارت را در مسیرهای مجاز پیاده یا آزمون کن: practitioner/availability/appointment و migration/constraints/timezone در kernel هر دو ZIP از یک schema authority ارائه شوند؛ نیازمندی note/psych بی‌دلیل به رزرو پایه وارد نشود.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: clean/upgrade و جابه‌جایی میزبان شناسه را حفظ کند؛ booking-only بدون جداول/endpointهای غیرمجاز دیگر قابل استفاده باشد.
...
- معیار اختصاصی: clean/upgrade و جابه‌جایی میزبان شناسه را حفظ کند؛ booking-only بدون جداول/endpointهای غیرمجاز دیگر قابل استفاده باشد.
...
- معیار موفقیت: clean/upgrade و جابه‌جایی میزبان شناسه را حفظ کند؛ booking-only بدون جداول/endpointهای غیرمجاز دیگر قابل استفاده باشد.
...
## Evidence
- مسیر: docs/evidence/P14-CLINIC-DATA-005/
