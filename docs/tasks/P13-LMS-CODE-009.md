# P13-LMS-CODE-009 — پخش/نمایش lesson با resume و completion policy
...
پخش/نمایش lesson با resume و completion policy

## خروجی مورد انتظار
refresh، دو دستگاه و network interruption تست شود
...
- معیار اختصاصی: refresh، دو دستگاه و network interruption تست شود
...
- انتظار: refresh، دو دستگاه و network interruption تست شود
...
## Evidence
- مسیر: docs/evidence/P13-LMS-CODE-009/
