# CT-SUPPORT-DOC-026 — ایجاد و نگه‌داری artifact: `docs/support/SUPPORT_AND_EOL.md`
...
ایجاد و نگه‌داری artifact: `docs/support/SUPPORT_AND_EOL.md`

## خروجی مورد انتظار
channel/SLA/severity/lifetime/upgrade path
...
- معیار اختصاصی: channel/SLA/severity/lifetime/upgrade path
...
- انتظار: channel/SLA/severity/lifetime/upgrade path
