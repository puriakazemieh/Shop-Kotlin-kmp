# CT-SUPPORT-DOC-026 — پشتیبانی و EOL مستقل خانواده محصول و اپ‌ساز
...
- Status: TODO
- Phase/Area/Type: CONTROL / SUPPORT / DOC
...
- Requirement source: Master checklist row CT-SUPPORT-DOC-026 و Source audit بخش SUPPORT
...
docs/support/SUPPORT_AND_EOL.md channel/SLA/severity/lifetime/upgrade را برای Theme/Plugin/client و build service مستقل تعیین کند.

## خروجی مورد انتظار
ownership مشکل hosting/provider/theme/kernel/runner و هزینه custom migration جدا؛ حقوق استفاده پس از پایان تمدید روشن.
...
3. قرارداد/مستند این کارت را با موارد زیر تطبیق و تصمیم‌های باز را ownerدار ثبت کن: docs/support/SUPPORT_AND_EOL.md channel/SLA/severity/lifetime/upgrade را برای Theme/Plugin/client و build service مستقل تعیین کند.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: ownership مشکل hosting/provider/theme/kernel/runner و هزینه custom migration جدا؛ حقوق استفاده پس از پایان تمدید روشن.
...
- معیار اختصاصی: ownership مشکل hosting/provider/theme/kernel/runner و هزینه custom migration جدا؛ حقوق استفاده پس از پایان تمدید روشن.
...
- معیار موفقیت: ownership مشکل hosting/provider/theme/kernel/runner و هزینه custom migration جدا؛ حقوق استفاده پس از پایان تمدید روشن.
...
## Evidence
- مسیر: docs/evidence/CT-SUPPORT-DOC-026/
