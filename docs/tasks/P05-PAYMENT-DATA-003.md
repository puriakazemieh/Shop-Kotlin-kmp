# P05-PAYMENT-DATA-003 — جدول‌ها، unique key و migration پرداخت
...
- Status: TODO
- Phase/Area/Type: P05 / PAYMENT / DATA
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P05-PAYMENT-CODE-002
- Blocks: P05-PAYMENT-CODE-004
- Requirement source: Master checklist row P05-PAYMENT-DATA-003 و Source audit بخش PAYMENT

## هدف قابل اندازه‌گیری
جدول‌ها، unique key و migration پرداخت

## خروجی مورد انتظار
idempotency/reference unique؛ rollback/forward fix
...
- Dependencyها: P05-PAYMENT-CODE-002
...
- معیار اختصاصی: idempotency/reference unique؛ rollback/forward fix
...
- انتظار: idempotency/reference unique؛ rollback/forward fix
...
## Evidence
- مسیر: docs/evidence/P05-PAYMENT-DATA-003/
