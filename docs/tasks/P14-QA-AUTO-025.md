# P14-QA-AUTO-025 — authorization matrix و negative API tests
...
authorization matrix و negative API tests

## خروجی مورد انتظار
cross-client/cross-practitioner access صفر
...
- معیار اختصاصی: cross-client/cross-practitioner access صفر
...
- انتظار: cross-client/cross-practitioner access صفر
