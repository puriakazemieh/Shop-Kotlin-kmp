# P14-QA-AUTO-025 — ماتریس مجوز نقش، رابطه، SKU و میزبان خدمات
...
- Status: TODO
- Phase/Area/Type: P14 / QA / AUTO
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: AI
- Completion authority: BOTH
- Depends on: P14-QA-AUTO-024
- Blocks: P14-QA-MANUAL-026
- Requirement source: Master checklist row P14-QA-AUTO-025 و Source audit بخش QA
...
negative API suite برای role/relationship و feature entitlement در Theme-only، Plugin-only و co-install اجرا شود؛ booking-only، consultation و psych جدا آزموده شوند.

## خروجی مورد انتظار
cross-client/cross-practitioner و feature bypass صفر؛ خاموشی قابلیت داده را حذف نکند و API خصوصی از public profile نشت نکند.
...
3. تغییر محدود این کارت را در مسیرهای مجاز پیاده یا آزمون کن: negative API suite برای role/relationship و feature entitlement در Theme-only، Plugin-only و co-install اجرا شود؛ booking-only، consultation و psych جدا آزموده شوند.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: cross-client/cross-practitioner و feature bypass صفر؛ خاموشی قابلیت داده را حذف نکند و API خصوصی از public profile نشت نکند.
...
- معیار اختصاصی: cross-client/cross-practitioner و feature bypass صفر؛ خاموشی قابلیت داده را حذف نکند و API خصوصی از public profile نشت نکند.
...
- معیار موفقیت: cross-client/cross-practitioner و feature bypass صفر؛ خاموشی قابلیت داده را حذف نکند و API خصوصی از public profile نشت نکند.
...
## Evidence
- مسیر: docs/evidence/P14-QA-AUTO-025/
