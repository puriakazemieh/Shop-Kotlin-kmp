# P05-PAYMENT-CODE-006 — hosted redirect + opaque HTTPS result session
...
- Depends on: P05-PAYMENT-CODE-005
- Blocks: P05-PAYMENT-CODE-007
- Requirement source: Master checklist row P05-PAYMENT-CODE-006 و Source audit بخش PAYMENT

## هدف قابل اندازه‌گیری
hosted redirect + opaque HTTPS result session

## خروجی مورد انتظار
WebView/direct card entry/merchant key در app صفر
...
- Dependencyها: P05-PAYMENT-CODE-005
...
- معیار اختصاصی: WebView/direct card entry/merchant key در app صفر
...
- انتظار: WebView/direct card entry/merchant key در app صفر
...
## Evidence
- مسیر: docs/evidence/P05-PAYMENT-CODE-006/
