...
# P03-MANIFEST-CODE-025D — اعمال guard عملیاتی کلینیک/نوبت
...
- Depends on: P03-MANIFEST-CODE-025C
- Blocks: P03-MANIFEST-CODE-025E
...
فقط مسیرهای repository/use-case/background دامنه کلینیک/نوبت را به وضعیت جاری feature متصل کن؛ قبل از ارسال درخواست guard اجرا شود و خاموشی حین عملیات با policy لغو/اتمام امن مشخص باشد. کنترل سروری همچنان الزامی است.
...
- `core/data/** و core/network/** فقط حوزه clinic`
- `feature/** فقط مصرف‌کننده همان حوزه`
- `composeApp/** فقط wiring/test`

- مستندات قرارداد مرتبط و `docs/evidence/P03-MANIFEST-CODE-025D/**`؛ row/card/checklist همین Task.
...
- مسیر: `docs/evidence/P03-MANIFEST-CODE-025D/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
