# P08-PWA-CODE-006 — cache policy فقط app shell/public catalog/content
...
- Depends on: P08-PWA-CODE-005
- Blocks: P08-PWA-CODE-007
- Requirement source: Master checklist row P08-PWA-CODE-006 و Source audit بخش PWA

## هدف قابل اندازه‌گیری
cache policy فقط app shell/public catalog/content

## خروجی مورد انتظار
auth/order/payment/message/health cache صفر
...
- معیار اختصاصی: auth/order/payment/message/health cache صفر
...
- انتظار: auth/order/payment/message/health cache صفر
...
## Evidence
- مسیر: docs/evidence/P08-PWA-CODE-006/
