# P03-MANIFEST-CODE-007 — feature catalog و dependency resolver پیاده شود
...
- Depends on: P03-SECURITY-CODE-006
- Blocks: P03-MANIFEST-CODE-008
- Requirement source: Master checklist row P03-MANIFEST-CODE-007 و Source audit بخش MANIFEST

## هدف قابل اندازه‌گیری
feature catalog و dependency resolver پیاده شود

## خروجی مورد انتظار
parent خاموش child را خاموش؛ cycle/unknown schema رد
...
- Dependencyها: P03-SECURITY-CODE-006
...
- معیار اختصاصی: parent خاموش child را خاموش؛ cycle/unknown schema رد
...
- انتظار: parent خاموش child را خاموش؛ cycle/unknown schema رد
...
## Evidence
- مسیر: docs/evidence/P03-MANIFEST-CODE-007/
...
- Evidence paths: `docs/evidence/P03-MANIFEST-CODE-007/summary.md`
- Remaining risks/blockers: resolver در bootstrap و guardهای runtime در Taskهای بعدی مصرف می‌شود؛ اجرای آزمون JVM پس از رفع loopback لازم است.
- Final status: DONE
