# P01-WPPLUGIN-SEC-011 — OTP hash، purpose، expiry، attempts، resend cooldown و debug-off
...
- Depends on: P01-WPPLUGIN-SEC-010
- Blocks: P01-WPPLUGIN-SEC-012
- Requirement source: Master checklist row P01-WPPLUGIN-SEC-011 و Source audit بخش WPPLUGIN
...
- Dependencyها: P01-WPPLUGIN-SEC-010
...
- معیار اختصاصی: brute force/rate/account enumeration tests
...
- انتظار: brute force/rate/account enumeration tests
...
## Evidence
- مسیر: docs/evidence/P01-WPPLUGIN-SEC-011/
