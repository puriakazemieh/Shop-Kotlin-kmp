# P07-MIGRATION-SEC-021 — AEAD encryption، signature/checksum، expiry/customer binding
...
- Phase/Area/Type: P07 / MIGRATION / SEC
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P07-MIGRATION-DATA-020
- Blocks: P07-MIGRATION-SEC-022
- Requirement source: Master checklist row P07-MIGRATION-SEC-021 و Source audit بخش MIGRATION

## هدف قابل اندازه‌گیری
AEAD encryption، signature/checksum، expiry/customer binding

## خروجی مورد انتظار
key خارج bundle؛ tamper/expired/wrong customer رد
...
- Dependencyها: P07-MIGRATION-DATA-020
...
- معیار اختصاصی: key خارج bundle؛ tamper/expired/wrong customer رد
...
- انتظار: key خارج bundle؛ tamper/expired/wrong customer رد
...
## Evidence
- مسیر: docs/evidence/P07-MIGRATION-SEC-021/
...
## Completion record
- Started at: 2026-09-08T10:22:19
- Completed at: 2026-09-08T10:24:30
- Changed files: wordpress/carmilla-bridge/includes/Migration/Migration_Crypto.php, wordpress/carmilla-bridge/includes/Migration/Export_Command.php, wordpress/carmilla-bridge/includes/Migration/Import_Command.php, wordpress/carmilla-bridge/includes/class-cb-standalone-boot.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: AWAITING_MANUAL_QA
- Evidence paths: docs/evidence/P07-MIGRATION-SEC-021/summary.md
