# P07-MIGRATION-DATA-020 — Base Pack و Customer Overlay نسخه مستقل
...
- Phase/Area/Type: P07 / MIGRATION / DATA
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P07-MIGRATION-CODE-019
- Blocks: P07-MIGRATION-SEC-021
- Requirement source: Master checklist row P07-MIGRATION-DATA-020 و Source audit بخش MIGRATION

## هدف قابل اندازه‌گیری
Base Pack و Customer Overlay نسخه مستقل

## خروجی مورد انتظار
core update customization را overwrite نکند
...
- Dependencyها: P07-MIGRATION-CODE-019
...
- معیار اختصاصی: core update customization را overwrite نکند
...
- انتظار: core update customization را overwrite نکند
...
## Evidence
- مسیر: docs/evidence/P07-MIGRATION-DATA-020/
...
## Completion record
- Started at: 2026-09-08T10:18:05
- Completed at: 2026-09-08T10:20:18
- Changed files: wordpress/carmilla-bridge/includes/Migration/Export_Overlay_Command.php, wordpress/carmilla-bridge/includes/class-cb-standalone-boot.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: AWAITING_MANUAL_QA
- Evidence paths: docs/evidence/P07-MIGRATION-DATA-020/summary.md
