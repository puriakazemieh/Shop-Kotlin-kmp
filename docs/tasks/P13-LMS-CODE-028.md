...
# P13-LMS-CODE-028 — پخش واقعی درس در Web/PWA
...
VideoPlayer.js.kt placeholder را برای درس مجاز با lifecycle مناسب وب کامل کن؛ signed URL expiry و refresh مجوز، resume و خطای شبکه را رعایت کن. موتور نمره/پرداخت تغییر نکند.
...
- `feature/details/src/jsMain/**`
- `feature/academy/** فقط اتصال player`
- `composeApp/src/webMain/**`
- `core/network/** فقط media contract`

- مستندات قرارداد مرتبط و `docs/evidence/P13-LMS-CODE-028/**`؛ row/card/checklist همین Task.
...
پخش/توقف/seek/resume واقعی مرورگر؛ lesson غیرمجاز/منقضی باز نشود؛ raw private media در cache عمومی نباشد.
...
- موفقیت: پخش/توقف/seek/resume واقعی مرورگر؛ lesson غیرمجاز/منقضی باز نشود؛ raw private media در cache عمومی نباشد.
...
- مسیر: `docs/evidence/P13-LMS-CODE-028/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
