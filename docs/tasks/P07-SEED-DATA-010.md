# P07-SEED-DATA-010 — `base-fa-v1`: home/about/contact/privacy/terms، menu، حداقل ۶ post و محتوای عمومی
...
- Depends on: P07-SEED-CODE-009
- Blocks: P07-SEED-DATA-011
- Requirement source: Master checklist row P07-SEED-DATA-010 و Source audit بخش SEED

## هدف قابل اندازه‌گیری
`base-fa-v1`: home/about/contact/privacy/terms، menu، حداقل ۶ post و محتوای عمومی

## خروجی مورد انتظار
synthetic، attribution، RTL و empty-state fixtures
...
- Dependencyها: P07-SEED-CODE-009
...
- معیار اختصاصی: synthetic، attribution، RTL و empty-state fixtures
...
- انتظار: synthetic، attribution، RTL و empty-state fixtures
...
## Evidence
- مسیر: docs/evidence/P07-SEED-DATA-010/
...
## Completion record
- Started at: 2026-09-07T18:07:44
- Completed at: 2026-09-07T18:08:15
- Changed files: wordpress/carmilla-bridge/seeds/base-fa-v1.json
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P07-SEED-DATA-010/summary.md
