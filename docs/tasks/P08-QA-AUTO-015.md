# P08-QA-AUTO-015 — تست مستقل Web/PWA در دو profile و سه host WordPress
...
- Requirement source: Master checklist row P08-QA-AUTO-015 و Source audit بخش QA
...
Playwright install/update/offline/cache/deep-link suite را روی production distribution اجرا کن؛ fixture قرارداد Spring از پذیرش backend واقعی جدا گزارش شود.

## خروجی مورد انتظار
tenant cache isolation، logout purge و feature guard سبز؛ report دارای backend/host/SKU/fingerprint؛ fake به‌عنوان production PASS گزارش نشود.
...
3. تغییر محدود این کارت را در مسیرهای مجاز پیاده یا آزمون کن: Playwright install/update/offline/cache/deep-link suite را روی production distribution اجرا کن؛ fixture قرارداد Spring از پذیرش backend واقعی جدا گزارش شود.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: tenant cache isolation، logout purge و feature guard سبز؛ report دارای backend/host/SKU/fingerprint؛ fake به‌عنوان production PASS گزارش نشود.
...
- معیار اختصاصی: tenant cache isolation، logout purge و feature guard سبز؛ report دارای backend/host/SKU/fingerprint؛ fake به‌عنوان production PASS گزارش نشود.
...
- معیار موفقیت: tenant cache isolation، logout purge و feature guard سبز؛ report دارای backend/host/SKU/fingerprint؛ fake به‌عنوان production PASS گزارش نشود.
...
## Evidence
- مسیر: docs/evidence/P08-QA-AUTO-015/
