# CT-ARCH-DOC-007 — ایجاد و نگه‌داری artifact: `docs/architecture/DEPENDENCY_POLICY.md`
...
ایجاد و نگه‌داری artifact: `docs/architecture/DEPENDENCY_POLICY.md`

## خروجی مورد انتظار
allowed/forbidden dependency و cycle rule
...
- معیار اختصاصی: allowed/forbidden dependency و cycle rule
...
- انتظار: allowed/forbidden dependency و cycle rule
