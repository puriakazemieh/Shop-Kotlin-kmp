# P06-MESSAGE-CODE-004 — `wp_mail` adapter پیش‌فرض
...
- Depends on: P06-MESSAGE-CODE-003
- Blocks: P06-MESSAGE-CODE-005
- Requirement source: Master checklist row P06-MESSAGE-CODE-004 و Source audit بخش MESSAGE

## هدف قابل اندازه‌گیری
`wp_mail` adapter پیش‌فرض

## خروجی مورد انتظار
با SMTP plugin متداول کار کند
...
- Dependencyها: P06-MESSAGE-CODE-003
...
- معیار اختصاصی: با SMTP plugin متداول کار کند
...
- انتظار: با SMTP plugin متداول کار کند
...
## Evidence
- مسیر: docs/evidence/P06-MESSAGE-CODE-004/
...
## Completion record
- Started at: 2026-09-07T16:29:07
- Completed at: 2026-09-07T16:29:32
- Changed files: wordpress/carmilla-bridge/includes/class-cb-mail-adapter.php, wordpress/carmilla-bridge/includes/class-cb-standalone-boot.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P06-MESSAGE-CODE-004/summary.md
