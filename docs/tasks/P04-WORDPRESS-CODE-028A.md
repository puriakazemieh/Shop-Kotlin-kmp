...
# P04-WORDPRESS-CODE-028A — انتقال مسیر ثبت و مشاهده نوبت موجود
...
appointment API و فرم‌های رزرو/نوبت‌های من/مدیریت را به Shared Core و adapterهای نمایشی هر میزبان وصل کن؛ mapping route فعلی booking.js به قرارداد واقعی را ثبت کن.
...
- مستندات قرارداد مرتبط و `docs/evidence/P04-WORDPRESS-CODE-028A/**`؛ row/card/checklist همین Task.
...
Theme-only ثبت synthetic بدون افزونه؛ Plugin-only فرم قابل استفاده؛ co-install یک نوبت؛ ID/ownership حفظ؛ readiness تولید پس از P14.
...
- موفقیت: Theme-only ثبت synthetic بدون افزونه؛ Plugin-only فرم قابل استفاده؛ co-install یک نوبت؛ ID/ownership حفظ؛ readiness تولید پس از P14.
...
- مسیر: `docs/evidence/P04-WORDPRESS-CODE-028A/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
