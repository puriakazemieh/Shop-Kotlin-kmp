# P14-CLINIC-CODE-017 — journal/mood/homework فقط در صورت Scope
...
- Depends on: P14-PSYCH-CODE-016
- Blocks: P14-CLINIC-SAFETY-018
- Requirement source: Master checklist row P14-CLINIC-CODE-017 و Source audit بخش CLINIC

## هدف قابل اندازه‌گیری
journal/mood/homework فقط در صورت Scope

## خروجی مورد انتظار
consent،private-by-default،export/delete تست شود
...
- Dependencyها: P14-PSYCH-CODE-016
...
- معیار اختصاصی: consent،private-by-default،export/delete تست شود
...
- انتظار: consent،private-by-default،export/delete تست شود
...
## Evidence
- مسیر: docs/evidence/P14-CLINIC-CODE-017/
