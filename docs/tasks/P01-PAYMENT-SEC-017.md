# P01-PAYMENT-SEC-017 — amount/currency/order/reference قبل از verify تطبیق و replay مسدود شود
...
- Status: TODO
- Phase/Area/Type: P01 / PAYMENT / SEC
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P01-WPPLUGIN-CODE-016
- Blocks: P01-WPPLUGIN-SEC-018
- Requirement source: Master checklist row P01-PAYMENT-SEC-017 و Source audit بخش PAYMENT
...
- Dependencyها: P01-WPPLUGIN-CODE-016
...
- معیار اختصاصی: wrong amount و duplicate callback هر دو fail/idempotent
...
- انتظار: wrong amount و duplicate callback هر دو fail/idempotent
...
## Evidence
- مسیر: docs/evidence/P01-PAYMENT-SEC-017/
