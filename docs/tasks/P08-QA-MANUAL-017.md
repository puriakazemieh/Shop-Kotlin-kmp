# P08-QA-MANUAL-017 — keyboard/screen reader/RTL/zoom 200%
...
- Depends on: P08-QA-MANUAL-016
- Blocks: P08-PWA-OPS-018
- Requirement source: Master checklist row P08-QA-MANUAL-017 و Source audit بخش QA

## هدف قابل اندازه‌گیری
keyboard/screen reader/RTL/zoom 200%

## خروجی مورد انتظار
golden pages و defect list
...
- Dependencyها: P08-QA-MANUAL-016
...
- معیار اختصاصی: golden pages و defect list
...
- انتظار: golden pages و defect list
...
## Evidence
- مسیر: docs/evidence/P08-QA-MANUAL-017/
...
## Completion record
- Prepared instructions for manual testing of a11y (keyboard/screen reader/RTL/zoom).
