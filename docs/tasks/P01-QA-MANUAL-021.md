# P01-QA-MANUAL-021 — تست دستی auth/IDOR/payment و اثبات بسته‌بودن Wallet/Booking/LMS/Clinic خارج Scope
...
- Depends on: P01-QA-AUTO-020
- Blocks: P01-SECURITY-SEC-022
- Requirement source: Master checklist row P01-QA-MANUAL-021 و Source audit بخش QA

## هدف قابل اندازه‌گیری
تست دستی auth/IDOR/payment و اثبات بسته‌بودن Wallet/Booking/LMS/Clinic خارج Scope

## خروجی مورد انتظار
tester/date/device/request IDs redacted ثبت
...
- معیار اختصاصی: tester/date/device/request IDs redacted ثبت
...
- انتظار: tester/date/device/request IDs redacted ثبت
...
## Evidence
- مسیر: docs/evidence/P01-QA-MANUAL-021/
