# P07-SEED-DATA-012 — `academy-fa-v1`: حداقل ۲ رایگان/۲ پولی، section/lesson/quiz/certificate
...
- Depends on: P07-SEED-DATA-011
- Blocks: P07-SEED-DATA-013
- Requirement source: Master checklist row P07-SEED-DATA-012 و Source audit بخش SEED

## هدف قابل اندازه‌گیری
`academy-fa-v1`: حداقل ۲ رایگان/۲ پولی، section/lesson/quiz/certificate

## خروجی مورد انتظار
محتوای دارای مجوز؛ entitlement fixture
...
- Dependencyها: P07-SEED-DATA-011
...
- معیار اختصاصی: محتوای دارای مجوز؛ entitlement fixture
...
- انتظار: محتوای دارای مجوز؛ entitlement fixture
...
## Evidence
- مسیر: docs/evidence/P07-SEED-DATA-012/
...
## Completion record
- Started at: 2026-09-07T18:26:00
- Completed at: 2026-09-07T18:28:00
- Changed files: wordpress/carmilla-bridge/seeds/academy-fa-v1.json
- Commands and exit codes: JSON validation (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P07-SEED-DATA-012/summary.md
- Remaining risks/blockers: Requires manual testing in WordPress with Academy feature
