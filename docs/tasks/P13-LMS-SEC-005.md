# P13-LMS-SEC-005 — نقش‌ها و capabilities مدرس/دانشجو/مدیر
...
- Depends on: P13-LMS-DATA-004
- Blocks: P13-LMS-CODE-006
- Requirement source: Master checklist row P13-LMS-SEC-005 و Source audit بخش LMS

## هدف قابل اندازه‌گیری
نقش‌ها و capabilities مدرس/دانشجو/مدیر

## خروجی مورد انتظار
deny-by-default و ماتریس RBAC/IDOR پاس شود
...
- معیار اختصاصی: deny-by-default و ماتریس RBAC/IDOR پاس شود
...
- انتظار: deny-by-default و ماتریس RBAC/IDOR پاس شود
...
## Evidence
- مسیر: docs/evidence/P13-LMS-SEC-005/
