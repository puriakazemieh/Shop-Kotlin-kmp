# P07-SEED-CODE-007 — rollback فقط object ساخته‌شده و تغییرنکرده
...
- Depends on: P07-SEED-CODE-006
- Blocks: P07-SEED-CODE-008
- Requirement source: Master checklist row P07-SEED-CODE-007 و Source audit بخش SEED

## هدف قابل اندازه‌گیری
rollback فقط object ساخته‌شده و تغییرنکرده
...
- Dependencyها: P07-SEED-CODE-006
...
- معیار اختصاصی: داده مشتری حذف نشود
...
## Evidence
- مسیر: docs/evidence/P07-SEED-CODE-007/
...
## Completion record
- Started at: 2026-09-07T18:02:39
- Completed at: 2026-09-07T18:03:51
...
- Evidence paths: docs/evidence/P07-SEED-CODE-007/summary.md
