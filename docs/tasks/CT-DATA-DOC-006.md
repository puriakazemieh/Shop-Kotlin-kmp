# CT-DATA-DOC-006 — مالکیت سایت و lifecycle داده مشترک دو ZIP
...
- Status: TODO
- Phase/Area/Type: CONTROL / DATA / DOC
...
- Requirement source: Master checklist row CT-DATA-DOC-006 و Source audit بخش DATA
...
docs/contracts/DATA_OWNERSHIP.md owner/read/write/delete/export هر entity و kernel فعال را ثبت کند؛ داده سایت از تنظیمات نمایشی Theme تفکیک شود.

## خروجی مورد انتظار
یک schema authority؛ خاموشی آخرین host اجرا را متوقف و داده را حفظ کند؛ انتقال host، license و cleanup صریح.
...
3. قرارداد/مستند این کارت را با موارد زیر تطبیق و تصمیم‌های باز را ownerدار ثبت کن: docs/contracts/DATA_OWNERSHIP.md owner/read/write/delete/export هر entity و kernel فعال را ثبت کند؛ داده سایت از تنظیمات نمایشی Theme تفکیک شود.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: یک schema authority؛ خاموشی آخرین host اجرا را متوقف و داده را حفظ کند؛ انتقال host، license و cleanup صریح.
...
- معیار اختصاصی: یک schema authority؛ خاموشی آخرین host اجرا را متوقف و داده را حفظ کند؛ انتقال host، license و cleanup صریح.
...
- معیار موفقیت: یک schema authority؛ خاموشی آخرین host اجرا را متوقف و داده را حفظ کند؛ انتقال host، license و cleanup صریح.
...
## Evidence
- مسیر: docs/evidence/CT-DATA-DOC-006/
