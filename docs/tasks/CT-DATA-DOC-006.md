# CT-DATA-DOC-006 — ایجاد و نگه‌داری artifact: `docs/contracts/DATA_OWNERSHIP.md`
...
ایجاد و نگه‌داری artifact: `docs/contracts/DATA_OWNERSHIP.md`

## خروجی مورد انتظار
owner/read/write/delete/export هر entity
...
- معیار اختصاصی: owner/read/write/delete/export هر entity
...
- انتظار: owner/read/write/delete/export هر entity
