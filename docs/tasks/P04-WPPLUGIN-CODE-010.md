# P04-WPPLUGIN-CODE-010 — نقش‌ها و capabilityهای Content/Shop/LMS/Clinic/Support تعریف شوند
...
نقش‌ها و capabilityهای Content/Shop/LMS/Clinic/Support تعریف شوند

## خروجی مورد انتظار
matrix تست؛ least privilege
...
- معیار اختصاصی: matrix تست؛ least privilege
...
- انتظار: matrix تست؛ least privilege
