...
# P04-WPPLUGIN-CODE-010 — registry نقش‌ها و مجوز عملیات در هسته مشترک
...
- Depends on: P04-WPPLUGIN-CODE-009
- Blocks: P04-WPPLUGIN-CODE-011
- Requirement source: Master checklist row P04-WPPLUGIN-CODE-010 و Source audit بخش WPPLUGIN
...
registry capability و mapping نقش‌های محتوا/فروشگاه/آموزش/کلینیک/پشتیبانی در kernel مشترک تعریف و اعمال مرز پایه تست شود؛ جزئیات هر endpoint در کارت دامنه اجرا می‌شود.

## خروجی مورد انتظار

مجوز نقش کاربر،حق خرید سایت و روشن‌بودن قابلیت سه کنترل مستقل باشند؛ خرید feature به کاربر عادی اختیار مدیریت یا مشاهده داده خصوصی ندهد.
...
- Dependencyها: P04-WPPLUGIN-CODE-009
...
- `docs/evidence/P04-WPPLUGIN-CODE-010/**` و وضعیت همین کارت در `docs/**`
...
1. نقش و permission callback موجود را به ماتریس عملیاتی دامنه‌ها نگاشت کن.
2. registry و adapter نقش‌های مشترک را بدون اعطای عمومی manage_options بساز.
3. تفکیک capability کاربر از entitlement سایت را در مرز پایه اعمال کن.
4. fixture مدیر/مدرس/متخصص/پشتیبان/مشتری و غیرمالک را در دو میزبان تست کن.
...
- معیار اختصاصی: مجوز نقش کاربر،حق خرید سایت و روشن‌بودن قابلیت سه کنترل مستقل باشند؛ خرید feature به کاربر عادی اختیار مدیریت یا مشاهده داده خصوصی ندهد.

## Manual tests با environment/data/steps/expected

- کجا: پیشخوان و یک فرم عمومی fixture هر میزبان با حساب‌های مصنوعی.
- چگونه: با نقش مجاز و غیرمجاز یک عملیات یکسان را امتحان کنید؛ سپس entitlement سایت را بدون تغییر نقش فعال کنید.
- معیار موفقیت: خرید قابلیت اختیارات کاربر را زیاد نکند و عملیات غیرمالک/غیرمجاز همچنان رد شود.
...
- [ ] registry یک source مشترک دارد.
- [ ] نقش،entitlement و toggle جدا اعمال می‌شوند.
- [ ] کمینه دسترسی و fixture منفی در هر دو host پاس‌اند.
- [ ] دامنه این کارت registry/مرز پایه است و جزئیات هر vertical به کارت خودش می‌رود.
...
## Evidence
- مسیر: docs/evidence/P04-WPPLUGIN-CODE-010/
