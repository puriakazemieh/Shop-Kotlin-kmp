# P14-PSYCH-DATA-013 — registry پرسش‌نامه: owner/license/version/norm/locale
...
- Status: TODO
- Phase/Area/Type: P14 / PSYCH / DATA
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P14-CLINIC-DATA-012
- Blocks: P14-PSYCH-CODE-014
- Requirement source: Master checklist row P14-PSYCH-DATA-013 و Source audit بخش PSYCH

## هدف قابل اندازه‌گیری
registry پرسش‌نامه: owner/license/version/norm/locale

## خروجی مورد انتظار
هر attempt به نسخه immutable متصل باشد
...
- Dependencyها: P14-CLINIC-DATA-012
...
- معیار اختصاصی: هر attempt به نسخه immutable متصل باشد
...
- انتظار: هر attempt به نسخه immutable متصل باشد
...
## Evidence
- مسیر: docs/evidence/P14-PSYCH-DATA-013/
