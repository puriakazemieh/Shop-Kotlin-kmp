# P13-QA-AUTO-021 — suite آموزش با SKU و parity میزبان‌ها
...
- Status: TODO
- Phase/Area/Type: P13 / QA / AUTO
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: AI
- Completion authority: BOTH
- Depends on: P13-LMS-LEGAL-020
- Blocks: P13-QA-MANUAL-022
- Requirement source: Master checklist row P13-QA-AUTO-021 و Source audit بخش QA
...
enrollment/refund/progress/score و آزمون‌های منفی مجوز را در Theme-only، Plugin-only و co-install اجرا کن؛ provider contract Spring و سقف کلاینت جدا بررسی شوند.

## خروجی مورد انتظار
مجوز دامنه و ثبت‌نام دانشجو مستقل enforce؛ route/write/job خاموش رد؛ score فقط سرور و stateها در backendها هم‌معنا باشند.
...
- Dependencyها: P13-LMS-LEGAL-020
...
3. تغییر محدود این کارت را در مسیرهای مجاز پیاده یا آزمون کن: enrollment/refund/progress/score و آزمون‌های منفی مجوز را در Theme-only، Plugin-only و co-install اجرا کن؛ provider contract Spring و سقف کلاینت جدا بررسی شوند.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: مجوز دامنه و ثبت‌نام دانشجو مستقل enforce؛ route/write/job خاموش رد؛ score فقط سرور و stateها در backendها هم‌معنا باشند.
...
- معیار اختصاصی: مجوز دامنه و ثبت‌نام دانشجو مستقل enforce؛ route/write/job خاموش رد؛ score فقط سرور و stateها در backendها هم‌معنا باشند.
...
- معیار موفقیت: مجوز دامنه و ثبت‌نام دانشجو مستقل enforce؛ route/write/job خاموش رد؛ score فقط سرور و stateها در backendها هم‌معنا باشند.
...
## Evidence
- مسیر: docs/evidence/P13-QA-AUTO-021/
