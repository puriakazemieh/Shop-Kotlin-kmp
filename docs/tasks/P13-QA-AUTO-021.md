# P13-QA-AUTO-021 — unit/integration/contract tests دامنه LMS
...
unit/integration/contract tests دامنه LMS

## خروجی مورد انتظار
enrollment،refund،progress و score پوشش داده شود
...
- معیار اختصاصی: enrollment،refund،progress و score پوشش داده شود
...
- انتظار: enrollment،refund،progress و score پوشش داده شود
