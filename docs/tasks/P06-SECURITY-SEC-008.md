# P06-SECURITY-SEC-008 — SSRF defense برای URL دلخواه
...
- Phase/Area/Type: P06 / SECURITY / SEC
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P06-SECURITY-CODE-007
- Blocks: P06-MESSAGE-CODE-009
- Requirement source: Master checklist row P06-SECURITY-SEC-008 و Source audit بخش SECURITY

## هدف قابل اندازه‌گیری
SSRF defense برای URL دلخواه

## خروجی مورد انتظار
HTTPS؛ private/loopback/metadata/redirect ناامن رد
...
- Dependencyها: P06-SECURITY-CODE-007
...
- معیار اختصاصی: HTTPS؛ private/loopback/metadata/redirect ناامن رد
...
- انتظار: HTTPS؛ private/loopback/metadata/redirect ناامن رد
...
## Evidence
- مسیر: docs/evidence/P06-SECURITY-SEC-008/
...
## Completion record
- Started at: 2026-09-07T16:42:21
- Completed at: 2026-09-07T16:42:54
- Changed files: wordpress/carmilla-bridge/includes/class-cb-sms-http-adapter.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P06-SECURITY-SEC-008/summary.md
