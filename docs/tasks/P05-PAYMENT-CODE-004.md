# P05-PAYMENT-CODE-004 — Woo gateway base با HPOS/Blocks و capability-driven UI
...
- Depends on: P05-PAYMENT-DATA-003
- Blocks: P05-PAYMENT-CODE-005
- Requirement source: Master checklist row P05-PAYMENT-CODE-004 و Source audit بخش PAYMENT

## هدف قابل اندازه‌گیری
Woo gateway base با HPOS/Blocks و capability-driven UI

## خروجی مورد انتظار
روش unsupported مخفی/disabled
...
- Dependencyها: P05-PAYMENT-DATA-003
...
- معیار اختصاصی: روش unsupported مخفی/disabled
...
- انتظار: روش unsupported مخفی/disabled
...
## Evidence
- مسیر: docs/evidence/P05-PAYMENT-CODE-004/
