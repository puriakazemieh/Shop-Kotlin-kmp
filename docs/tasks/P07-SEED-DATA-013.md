# P07-SEED-DATA-013 — `clinic-public-fa-v1`: متخصص/خدمت/slot کاملاً synthetic
...
- Depends on: P07-SEED-DATA-012
- Blocks: P07-SEED-DATA-014
- Requirement source: Master checklist row P07-SEED-DATA-013 و Source audit بخش SEED

## هدف قابل اندازه‌گیری
`clinic-public-fa-v1`: متخصص/خدمت/slot کاملاً synthetic

## خروجی مورد انتظار
patient/appointment واقعی صفر
...
- Dependencyها: P07-SEED-DATA-012
...
- معیار اختصاصی: patient/appointment واقعی صفر
...
- انتظار: patient/appointment واقعی صفر
...
## Evidence
- مسیر: docs/evidence/P07-SEED-DATA-013/
...
## Completion record
- Started at: 2026-09-08T09:50:00
- Completed at: 2026-09-08T09:51:51
- Changed files: wordpress/carmilla-bridge/seeds/clinic-public-fa-v1.json
- Commands and exit codes: JSON validation (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P07-SEED-DATA-013/summary.md
