# P06-MESSAGE-CODE-006 — Generic Email REST/SMTP configuration
...
- Depends on: P06-MESSAGE-CODE-005
- Blocks: P06-SECURITY-CODE-007
- Requirement source: Master checklist row P06-MESSAGE-CODE-006 و Source audit بخش MESSAGE

## هدف قابل اندازه‌گیری
Generic Email REST/SMTP configuration

## خروجی مورد انتظار
TLS/port/from/credential validation
...
- Dependencyها: P06-MESSAGE-CODE-005
...
- معیار اختصاصی: TLS/port/from/credential validation
...
- انتظار: TLS/port/from/credential validation
...
## Evidence
- مسیر: docs/evidence/P06-MESSAGE-CODE-006/
...
## Completion record
- Started at: 2026-09-07T16:33:16
- Completed at: 2026-09-07T16:34:04
- Changed files: wordpress/carmilla-bridge/includes/class-cb-mail-adapter.php, wordpress/carmilla-bridge/includes/class-cb-plugin.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P06-MESSAGE-CODE-006/summary.md
