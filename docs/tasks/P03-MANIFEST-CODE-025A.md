...
# P03-MANIFEST-CODE-025A — اتصال منو و route/deep link به وضعیت مؤثر
...
- Depends on: P03-MANIFEST-CODE-025
- Blocks: P03-MANIFEST-CODE-025B
...
FeatureRouteGuard، AppNavigation و MainGraphScreen از store جاری بخوانند؛ brand.features منبع تصمیم runtime نباشد. خروج از صفحه قابلیت خاموش و پیام قابل فهم تعریف شود.
...
- مستندات قرارداد مرتبط و `docs/evidence/P03-MANIFEST-CODE-025A/**`؛ row/card/checklist همین Task.
...
toggle منو و deep link را بدون rebuild هم‌زمان ببندد؛ restart و back stack مسیر ممنوع باز نکنند.
...
- موفقیت: toggle منو و deep link را بدون rebuild هم‌زمان ببندد؛ restart و back stack مسیر ممنوع باز نکنند.
...
- مسیر: `docs/evidence/P03-MANIFEST-CODE-025A/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
