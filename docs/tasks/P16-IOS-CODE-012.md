# P16-IOS-CODE-012 — social login policy؛ Sign in with Apple در صورت الزام
...
- Depends on: P16-IOS-CODE-011
- Blocks: P16-IOS-CODE-013
- Requirement source: Master checklist row P16-IOS-CODE-012 و Source audit بخش IOS

## هدف قابل اندازه‌گیری
social login policy؛ Sign in with Apple در صورت الزام

## خروجی مورد انتظار
login/link/unlink/delete tests
...
- معیار اختصاصی: login/link/unlink/delete tests
...
- انتظار: login/link/unlink/delete tests
...
## Evidence
- مسیر: docs/evidence/P16-IOS-CODE-012/
