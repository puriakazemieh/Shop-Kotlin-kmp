...
# P04-WORDPRESS-CODE-027A — انتقال ثبت‌نام و پیشرفت آموزش با view مشترک
...
- Blocks: P04-WORDPRESS-CODE-027B
...
Enrollment/Progress و صفحه درس/دوره‌های من موجود را از خدمات مشترک در Theme و Plugin مصرف کن؛ تکمیل product-grade paywall در P13 جدا باقی است.
...
- مستندات قرارداد مرتبط و `docs/evidence/P04-WORDPRESS-CODE-027A/**`؛ row/card/checklist همین Task.
...
سه mode یک نتیجه؛ شناسه و progress حفظ؛ نمایش plugin روی قالب ثالث؛ دسترسی private بدون enrollment مجاز باز نشود.
...
- موفقیت: سه mode یک نتیجه؛ شناسه و progress حفظ؛ نمایش plugin روی قالب ثالث؛ دسترسی private بدون enrollment مجاز باز نشود.
...
- مسیر: `docs/evidence/P04-WORDPRESS-CODE-027A/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
