# P14-CLINIC-CODE-007 — رزرو اتمیک slot با hold/expiry
...
رزرو اتمیک slot با hold/expiry

## خروجی مورد انتظار
۱۰۰ درخواست همزمان double-booking ایجاد نکند
...
- معیار اختصاصی: ۱۰۰ درخواست همزمان double-booking ایجاد نکند
...
- انتظار: ۱۰۰ درخواست همزمان double-booking ایجاد نکند
