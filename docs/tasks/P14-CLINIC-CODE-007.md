# P14-CLINIC-CODE-007 — رزرو اتمیک با hold و expiry در هر دو محصول مستقل
...
- Status: TODO
- Phase/Area/Type: P14 / CLINIC / CODE
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P14-CLINIC-CODE-006
- Blocks: P14-CLINIC-CODE-008
- Requirement source: Master checklist row P14-CLINIC-CODE-007 و Source audit بخش CLINIC
...
slot hold/expiry و ثبت نوبت در Shared Core واحد باشد؛ فرم Theme و فرم مستقل Plugin و client API همان عملیات canonical را مصرف کنند.

## خروجی مورد انتظار
۱۰۰ درخواست هم‌زمان double booking نسازند؛ co-install یک اثر؛ feature خاموش یا مجوز غایب عملیات جدید را رد کند.
...
- Dependencyها: P14-CLINIC-CODE-006
...
3. تغییر محدود این کارت را در مسیرهای مجاز پیاده یا آزمون کن: slot hold/expiry و ثبت نوبت در Shared Core واحد باشد؛ فرم Theme و فرم مستقل Plugin و client API همان عملیات canonical را مصرف کنند.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: ۱۰۰ درخواست هم‌زمان double booking نسازند؛ co-install یک اثر؛ feature خاموش یا مجوز غایب عملیات جدید را رد کند.
...
- معیار اختصاصی: ۱۰۰ درخواست هم‌زمان double booking نسازند؛ co-install یک اثر؛ feature خاموش یا مجوز غایب عملیات جدید را رد کند.
...
- معیار موفقیت: ۱۰۰ درخواست هم‌زمان double booking نسازند؛ co-install یک اثر؛ feature خاموش یا مجوز غایب عملیات جدید را رد کند.
...
## Evidence
- مسیر: docs/evidence/P14-CLINIC-CODE-007/
