# P13-LMS-SEC-012 — پاسخ صحیح و score server-authoritative
...
- Status: TODO
- Phase/Area/Type: P13 / LMS / SEC
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH
- Depends on: P13-LMS-CODE-011
- Blocks: P13-LMS-CODE-013
- Requirement source: Master checklist row P13-LMS-SEC-012 و Source audit بخش LMS

## هدف قابل اندازه‌گیری
پاسخ صحیح و score server-authoritative

## خروجی مورد انتظار
پاسخ/کلید در payload عمومی یا source client نباشد
...
- معیار اختصاصی: پاسخ/کلید در payload عمومی یا source client نباشد
...
- انتظار: پاسخ/کلید در payload عمومی یا source client نباشد
...
## Evidence
- مسیر: docs/evidence/P13-LMS-SEC-012/
