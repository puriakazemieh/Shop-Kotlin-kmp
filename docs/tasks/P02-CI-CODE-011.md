# P02-CI-CODE-011 — dependency locking/verification و secret scan اضافه شود
...
- Depends on: P02-CI-CODE-010
- Blocks: P02-ARCH-ADR-012
- Requirement source: Master checklist row P02-CI-CODE-011 و Source audit بخش CI

## هدف قابل اندازه‌گیری
dependency locking/verification و secret scan اضافه شود

## خروجی مورد انتظار
tampered dependency/known secret fixture CI را fail کند
...
- معیار اختصاصی: tampered dependency/known secret fixture CI را fail کند
...
- انتظار: tampered dependency/known secret fixture CI را fail کند
...
## Evidence
- مسیر: docs/evidence/P02-CI-CODE-011/
...
## Completion record
- Started at: 2026-08-26T11:02:20+03:30
- Completed at: 2026-08-26T11:05:00+03:30
- Changed files: .github/workflows/security.yml, gradle/verification-metadata.xml
- Commands and exit codes: N/A
- Manual tester/date/result: N/A
- Evidence paths: docs/evidence/P02-CI-CODE-011/EVIDENCE.md
