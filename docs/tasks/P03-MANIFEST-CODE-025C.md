...
# P03-MANIFEST-CODE-025C — اعمال guard عملیاتی آموزش
...
- Depends on: P03-MANIFEST-CODE-025B
- Blocks: P03-MANIFEST-CODE-025D
...
فقط مسیرهای repository/use-case/background دامنه آموزش را به وضعیت جاری feature متصل کن؛ قبل از ارسال درخواست guard اجرا شود و خاموشی حین عملیات با policy لغو/اتمام امن مشخص باشد. کنترل سروری همچنان الزامی است.
...
- `core/data/** و core/network/** فقط حوزه academy`
- `feature/** فقط مصرف‌کننده همان حوزه`
- `composeApp/** فقط wiring/test`

- مستندات قرارداد مرتبط و `docs/evidence/P03-MANIFEST-CODE-025C/**`؛ row/card/checklist همین Task.
...
- مسیر: `docs/evidence/P03-MANIFEST-CODE-025C/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
