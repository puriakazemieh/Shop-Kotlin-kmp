# P08-PWA-CODE-004 — `manifest.webmanifest` با id/scope/start_url/name/icons
...
- Depends on: P08-PWA-CODE-003
- Blocks: P08-PWA-CODE-005
- Requirement source: Master checklist row P08-PWA-CODE-004 و Source audit بخش PWA

## هدف قابل اندازه‌گیری
`manifest.webmanifest` با id/scope/start_url/name/icons

## خروجی مورد انتظار
installability check؛ icon sizes
...
- معیار اختصاصی: installability check؛ icon sizes
...
- انتظار: installability check؛ icon sizes
...
## Evidence
- مسیر: docs/evidence/P08-PWA-CODE-004/
...
## Completion record
- Started at: 2026-09-08T11:10:53
- Completed at: 2026-09-08T11:11:43
- Changed files: composeApp/build.gradle.kts, composeApp/src/webMain/resources/icon-192.png, composeApp/src/webMain/resources/icon-512.png
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: AI / 2026-09-08 / PASS
- Evidence paths: docs/evidence/P08-PWA-CODE-004/summary.md
