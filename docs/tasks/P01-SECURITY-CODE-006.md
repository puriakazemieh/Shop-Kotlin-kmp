# P01-SECURITY-CODE-006 — `?api=` و override origin آزاد از production حذف یا allowlist شود
...
- Depends on: P01-SECURITY-CODE-005
- Blocks: P01-PAYMENT-CODE-007
- Requirement source: Master checklist row P01-SECURITY-CODE-006 و Source audit بخش SECURITY
...
- Dependencyها: P01-SECURITY-CODE-005
...
- معیار اختصاصی: localhost/private/foreign URL در release رد شود
...
- انتظار: localhost/private/foreign URL در release رد شود
...
## Evidence
- مسیر: docs/evidence/P01-SECURITY-CODE-006/
