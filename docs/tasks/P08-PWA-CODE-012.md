# P08-PWA-CODE-012 — deep link/history/back/refresh/share target در scope
...
- Depends on: P08-PWA-CODE-011
- Blocks: P08-OBSERVABILITY-CODE-013
- Requirement source: Master checklist row P08-PWA-CODE-012 و Source audit بخش PWA

## هدف قابل اندازه‌گیری
deep link/history/back/refresh/share target در scope

## خروجی مورد انتظار
route داخلی refresh 404 نشود
...
- معیار اختصاصی: route داخلی refresh 404 نشود
...
- انتظار: route داخلی refresh 404 نشود
...
## Evidence
- مسیر: docs/evidence/P08-PWA-CODE-012/
...
## Completion record
- Started at: 2026-09-08T11:52:37
- Completed at: 2026-09-08T11:53:15
- Changed files: composeApp/build.gradle.kts
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: AI / 2026-09-08 / PASS
- Evidence paths: docs/evidence/P08-PWA-CODE-012/summary.md
