# P14-CLINIC-ADR-002 — ADR تفکیک داده عمومی،حساب،رزرو،سلامت و یادداشت محرمانه
...
ADR تفکیک داده عمومی،حساب،رزرو،سلامت و یادداشت محرمانه

## خروجی مورد انتظار
owner/processor/retention/access هر کلاس روشن
...
- معیار اختصاصی: owner/processor/retention/access هر کلاس روشن
...
- انتظار: owner/processor/retention/access هر کلاس روشن
