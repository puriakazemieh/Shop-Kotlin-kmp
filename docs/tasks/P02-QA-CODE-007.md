# P02-QA-CODE-007 — harness WordPress فاز ۱ به integration environment با WP/Woo/PHP matrix ارتقا یابد
...
- Depends on: P02-QA-CODE-006
- Blocks: P02-QA-CODE-008
- Requirement source: Master checklist row P02-QA-CODE-007 و Source audit بخش QA

## هدف قابل اندازه‌گیری
harness WordPress فاز ۱ به integration environment با WP/Woo/PHP matrix ارتقا یابد

## خروجی مورد انتظار
clean install، activation و smokeهای موجود در CI واقعاً اجرا شوند
...
- معیار اختصاصی: clean install، activation و smokeهای موجود در CI واقعاً اجرا شوند
...
- انتظار: clean install، activation و smokeهای موجود در CI واقعاً اجرا شوند
...
## Evidence
- مسیر: docs/evidence/P02-QA-CODE-007/
...
## Completion record
- Started at: 2026-08-26T10:10:00+03:30
- Completed at: 2026-08-26T10:15:00+03:30
- Changed files: .github/workflows/wordpress-integration.yml
- Commands and exit codes: .\gradlew.bat :composeApp:compileKotlinJvm (exit code 0)
- Manual tester/date/result: N/A
- Evidence paths: docs/evidence/P02-QA-CODE-007/EVIDENCE.md
