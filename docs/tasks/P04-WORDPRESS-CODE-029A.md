...
# P04-WORDPRESS-CODE-029A — انتقال پشتیبانی و تیکت با نمایش دو میزبان
...
- Blocks: P04-WORDPRESS-CODE-029B
...
ticket/thread/attachment موجود، permission و فرم‌های عمومی/مدیریتی پشتیبانی را به یک implementation مشترک منتقل کن؛ داده تست و clinical message را مخلوط نکن.
...
- مستندات قرارداد مرتبط و `docs/evidence/P04-WORDPRESS-CODE-029A/**`؛ row/card/checklist همین Task.
...
فقط مالک/نقش مجاز thread را ببیند؛ سه mode CRUD برابر؛ فایل خصوصی در قالب ثالث افشا نشود.
...
- موفقیت: فقط مالک/نقش مجاز thread را ببیند؛ سه mode CRUD برابر؛ فایل خصوصی در قالب ثالث افشا نشود.
...
- مسیر: `docs/evidence/P04-WORDPRESS-CODE-029A/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
