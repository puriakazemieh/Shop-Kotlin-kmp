# P07-SEED-DATA-014 — `psych-synthetic-fa-v1`: نمونه غیرتشخیصی و بدون copyright نامعلوم
...
- Depends on: P07-SEED-DATA-013
- Blocks: P07-SEED-DATA-015
- Requirement source: Master checklist row P07-SEED-DATA-014 و Source audit بخش SEED

## هدف قابل اندازه‌گیری
`psych-synthetic-fa-v1`: نمونه غیرتشخیصی و بدون copyright نامعلوم

## خروجی مورد انتظار
disclaimer؛ پاسخ/نتیجه واقعی صفر
...
- Dependencyها: P07-SEED-DATA-013
...
- معیار اختصاصی: disclaimer؛ پاسخ/نتیجه واقعی صفر
...
- انتظار: disclaimer؛ پاسخ/نتیجه واقعی صفر
...
## Evidence
- مسیر: docs/evidence/P07-SEED-DATA-014/
...
## Completion record
- Started at: 2026-09-08T09:52:33
- Completed at: 2026-09-08T09:52:56
- Changed files: wordpress/carmilla-bridge/seeds/psych-synthetic-fa-v1.json
- Commands and exit codes: JSON validation (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P07-SEED-DATA-014/summary.md
