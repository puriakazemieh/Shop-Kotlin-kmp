# P14-PSYCH-CODE-014 — اجرای تست،resume،submit و scoring server-side
...
- Status: TODO
- Phase/Area/Type: P14 / PSYCH / CODE
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P14-PSYCH-DATA-013
- Blocks: P14-PSYCH-CODE-015
- Requirement source: Master checklist row P14-PSYCH-CODE-014 و Source audit بخش PSYCH

## هدف قابل اندازه‌گیری
اجرای تست،resume،submit و scoring server-side

## خروجی مورد انتظار
answer key/score formula از client مخفی؛ golden cases
...
- Dependencyها: P14-PSYCH-DATA-013
...
- معیار اختصاصی: answer key/score formula از client مخفی؛ golden cases
...
- انتظار: answer key/score formula از client مخفی؛ golden cases
...
## Evidence
- مسیر: docs/evidence/P14-PSYCH-CODE-014/
