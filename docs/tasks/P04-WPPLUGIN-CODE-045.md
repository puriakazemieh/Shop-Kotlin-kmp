...
# P04-WPPLUGIN-CODE-045 — زیرساخت نمایش عمومی افزونه روی قالب ثالث
...
registry صفحه/shortcode/block، CSS scoped، template fallback و override قرارداد Carmilla Theme را برای یک صفحه نمونه محتوای عمومی بساز. پیاده‌سازی verticalها در کارت‌های انتقال جدا انجام می‌شود.
...
- مستندات قرارداد مرتبط و `docs/evidence/P04-WPPLUGIN-CODE-045/**`؛ row/card/checklist همین Task.
...
بدون Carmilla Theme صفحه نمونه از روی ZIP plugin رندر شود؛ سبک قالب ثالث خراب نشود؛ یک route/صفحه و permission درست.
...
- موفقیت: بدون Carmilla Theme صفحه نمونه از روی ZIP plugin رندر شود؛ سبک قالب ثالث خراب نشود؛ یک route/صفحه و permission درست.
...
- مسیر: `docs/evidence/P04-WPPLUGIN-CODE-045/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
