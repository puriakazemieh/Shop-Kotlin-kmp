...
# P04-WORDPRESS-CODE-029B — انتقال تعاملات محتوا و محصول
...
- Depends on: P04-WORDPRESS-CODE-029A
...
favorite/review/comment/Q&A موجود را inventory و یک adapter مشترک برای رفتار فعلی بساز؛ قابلیت‌هایی که بیش از این slice هستند با کارت مستقل ثبت شوند.
...
- مستندات قرارداد مرتبط و `docs/evidence/P04-WORDPRESS-CODE-029B/**`؛ row/card/checklist همین Task.
...
before/after fixture برابر؛ یک review/write؛ nonce/ownership و استایل scoped در دو میزبان.
...
- موفقیت: before/after fixture برابر؛ یک review/write؛ nonce/ownership و استایل scoped در دو میزبان.
...
- مسیر: `docs/evidence/P04-WORDPRESS-CODE-029B/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
