# P12-BUILDER-BIZ-018 — operator-assisted alpha قبل از self-service
...
- Depends on: P12-SECURITY-SEC-017
- Blocks: P12-BUILDER-GATE-019
- Requirement source: Master checklist row P12-BUILDER-BIZ-018 و Source audit بخش BUILDER

## هدف قابل اندازه‌گیری
operator-assisted alpha قبل از self-service

## خروجی مورد انتظار
۳–۵ project؛ support/cost evidence
...
- Dependencyها: P12-SECURITY-SEC-017
...
- معیار اختصاصی: ۳–۵ project؛ support/cost evidence
...
- انتظار: ۳–۵ project؛ support/cost evidence
...
## Evidence
- مسیر: docs/evidence/P12-BUILDER-BIZ-018/
