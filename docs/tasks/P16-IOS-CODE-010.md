# P16-IOS-CODE-010 — permission purpose strings و privacy manifest
...
- Depends on: P16-IOS-CODE-009
- Blocks: P16-IOS-CODE-011
- Requirement source: Master checklist row P16-IOS-CODE-010 و Source audit بخش IOS

## هدف قابل اندازه‌گیری
permission purpose strings و privacy manifest

## خروجی مورد انتظار
SDK/data collection inventory منطبق
...
- معیار اختصاصی: SDK/data collection inventory منطبق
...
- انتظار: SDK/data collection inventory منطبق
...
## Evidence
- مسیر: docs/evidence/P16-IOS-CODE-010/
