# P02-ARCH-ADR-012 — ADR جداسازی Android application shell برای AGP 9
...
- Depends on: P02-CI-CODE-011
- Blocks: P02-ARCH-CODE-013
- Requirement source: Master checklist row P02-ARCH-ADR-012 و Source audit بخش ARCH

## هدف قابل اندازه‌گیری
ADR جداسازی Android application shell برای AGP 9

## خروجی مورد انتظار
package/signing/resources/source-set migration و rollback روشن
...
- معیار اختصاصی: package/signing/resources/source-set migration و rollback روشن
...
- انتظار: package/signing/resources/source-set migration و rollback روشن
...
## Evidence
- مسیر: docs/evidence/P02-ARCH-ADR-012/
