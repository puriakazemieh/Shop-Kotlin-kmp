# P12-BUILDER-CODE-005 — queue/job state/retry/cancel/timeout
...
- Depends on: P12-BUILDER-CODE-004
- Blocks: P12-BUILDER-OPS-006
- Requirement source: Master checklist row P12-BUILDER-CODE-005 و Source audit بخش BUILDER

## هدف قابل اندازه‌گیری
queue/job state/retry/cancel/timeout

## خروجی مورد انتظار
duplicate build idempotent؛ stuck recovery
...
- Dependencyها: P12-BUILDER-CODE-004
...
- معیار اختصاصی: duplicate build idempotent؛ stuck recovery
...
- انتظار: duplicate build idempotent؛ stuck recovery
...
## Evidence
- مسیر: docs/evidence/P12-BUILDER-CODE-005/
