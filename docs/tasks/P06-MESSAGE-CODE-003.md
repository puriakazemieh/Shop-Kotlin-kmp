# P06-MESSAGE-CODE-003 — پنل `Carmilla → Integrations` با capability اختصاصی
...
- Depends on: P06-MESSAGE-DATA-002
- Blocks: P06-MESSAGE-CODE-004
- Requirement source: Master checklist row P06-MESSAGE-CODE-003 و Source audit بخش MESSAGE

## هدف قابل اندازه‌گیری
پنل `Carmilla → Integrations` با capability اختصاصی

## خروجی مورد انتظار
SMS/Email/Templates/Health/Test tabs
...
- Dependencyها: P06-MESSAGE-DATA-002
...
- معیار اختصاصی: SMS/Email/Templates/Health/Test tabs
...
- انتظار: SMS/Email/Templates/Health/Test tabs
...
## Evidence
- مسیر: docs/evidence/P06-MESSAGE-CODE-003/
...
## Completion record
- Started at: 2026-09-07T16:22:23
- Completed at: 2026-09-07T16:27:15
- Changed files: wordpress/carmilla-bridge/includes/class-cb-integrations-controller.php, wordpress/carmilla-bridge/includes/class-cb-standalone-boot.php, wordpress/carmilla-bridge/includes/class-cb-plugin.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P06-MESSAGE-CODE-003/summary.md
