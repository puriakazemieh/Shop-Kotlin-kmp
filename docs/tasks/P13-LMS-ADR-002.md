# P13-LMS-ADR-002 — ADR مالکیت داده و مدل canonical آموزش
...
ADR مالکیت داده و مدل canonical آموزش

## خروجی مورد انتظار
منبع حقیقت هر entity و write path یکتا باشد
...
- معیار اختصاصی: منبع حقیقت هر entity و write path یکتا باشد
...
- انتظار: منبع حقیقت هر entity و write path یکتا باشد
