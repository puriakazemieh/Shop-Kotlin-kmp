# P13-LMS-ADR-002 — مالکیت canonical آموزش و مجوز بسته مستقل
...
- Status: TODO
- Phase/Area/Type: P13 / LMS / ADR
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH
- Depends on: P13-LMS-DISC-001
- Blocks: P13-LMS-DATA-003
- Requirement source: Master checklist row P13-LMS-ADR-002 و Source audit بخش LMS
...
Course/Section/Lesson/Enrollment/Progress/Quiz/Certificate در Shared Core هر دو ZIP یک owner و write path داشته باشند؛ entitlement خرید نرم‌افزار از enrollment دانشجو جدا شود.

## خروجی مورد انتظار
نقشه entity/API/role/SKU و frontend هر میزبان؛ قرارداد backend Spring هم‌معنا؛ UI-only بودن Theme یا اجبار Plugin در قرارداد نباشد.
...
3. قرارداد/مستند این کارت را با موارد زیر تطبیق و تصمیم‌های باز را ownerدار ثبت کن: Course/Section/Lesson/Enrollment/Progress/Quiz/Certificate در Shared Core هر دو ZIP یک owner و write path داشته باشند؛ entitlement خرید نرم‌افزار از enrollment دانشجو جدا شود.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: نقشه entity/API/role/SKU و frontend هر میزبان؛ قرارداد backend Spring هم‌معنا؛ UI-only بودن Theme یا اجبار Plugin در قرارداد نباشد.
...
- معیار اختصاصی: نقشه entity/API/role/SKU و frontend هر میزبان؛ قرارداد backend Spring هم‌معنا؛ UI-only بودن Theme یا اجبار Plugin در قرارداد نباشد.
...
- معیار موفقیت: نقشه entity/API/role/SKU و frontend هر میزبان؛ قرارداد backend Spring هم‌معنا؛ UI-only بودن Theme یا اجبار Plugin در قرارداد نباشد.
...
## Evidence
- مسیر: docs/evidence/P13-LMS-ADR-002/
