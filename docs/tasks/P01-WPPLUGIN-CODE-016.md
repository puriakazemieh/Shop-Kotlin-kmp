# P01-WPPLUGIN-CODE-016 — Booking خارج Scope نسخه اول deregister/fail-closed شود؛ hardening کامل فقط اگر surface فعلی قابل دسترس است
...
- Depends on: P01-WPPLUGIN-CODE-015
- Blocks: P01-PAYMENT-SEC-017
- Requirement source: Master checklist row P01-WPPLUGIN-CODE-016 و Source audit بخش WPPLUGIN
...
- Dependencyها: P01-WPPLUGIN-CODE-015
...
- معیار اختصاصی: feature خاموش endpoint/job صفر؛ legacy فعال دو رزرو هم‌زمان فقط یک winner
...
- انتظار: feature خاموش endpoint/job صفر؛ legacy فعال دو رزرو هم‌زمان فقط یک winner
...
## Evidence
- مسیر: docs/evidence/P01-WPPLUGIN-CODE-016/
