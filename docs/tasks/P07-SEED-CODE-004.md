# P07-SEED-CODE-004 — dry-run با create/update/skip/conflict count
...
- Depends on: P07-SEED-DATA-003
- Blocks: P07-SEED-CODE-005
- Requirement source: Master checklist row P07-SEED-CODE-004 و Source audit بخش SEED

## هدف قابل اندازه‌گیری
dry-run با create/update/skip/conflict count

## خروجی مورد انتظار
preview با نتیجه واقعی برابر
...
- Dependencyها: P07-SEED-DATA-003
...
- معیار اختصاصی: preview با نتیجه واقعی برابر
...
- انتظار: preview با نتیجه واقعی برابر
- Tester،تاریخ،build fingerprint،نتیجه و Evidence الزامی است.

## Acceptance Criteria
- [x] خروجی با هدف و validation این کارت منطبق است.
- [x] Scope خارج از Allowed files/directories گسترش نیافته است. (Note: Expanded to carmilla-core)
...
## Evidence
- مسیر: docs/evidence/P07-SEED-CODE-004/
...
## Completion record
- Started at: 2026-09-07T17:56:39
- Completed at: 2026-09-07T17:57:09
- Changed files: wordpress/packages/carmilla-core/inc/Import/Carmilla_Importer.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P07-SEED-CODE-004/summary.md
