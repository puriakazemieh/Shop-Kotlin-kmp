# P03-MANIFEST-CODE-008 — compiled feature ceiling و platform policy اضافه شود
...
- Depends on: P03-MANIFEST-CODE-007
- Blocks: P03-WPPLUGIN-CODE-009
- Requirement source: Master checklist row P03-MANIFEST-CODE-008 و Source audit بخش MANIFEST

## هدف قابل اندازه‌گیری
compiled feature ceiling و platform policy اضافه شود

## خروجی مورد انتظار
Clinic/Psych/Admin/Payment خارج ceiling روشن نشوند
...
- Dependencyها: P03-MANIFEST-CODE-007
...
- معیار اختصاصی: Clinic/Psych/Admin/Payment خارج ceiling روشن نشوند
...
- انتظار: Clinic/Psych/Admin/Payment خارج ceiling روشن نشوند
...
## Evidence
- مسیر: docs/evidence/P03-MANIFEST-CODE-008/
...
- Changed files: `core/config/capabilities/**`، صف، checklist و evidence همین Task.
- Commands and exit codes: `./gradlew.bat :core:config:capabilities:jvmTest` (exit 1؛ خطای loopback محیط Gradle پیش از configuration).
- Manual tester/date/result: N/A؛ تغییر UI، network یا migration ندارد.
- Evidence paths: `docs/evidence/P03-MANIFEST-CODE-008/summary.md`
- Remaining risks/blockers: ceiling باید در bootstrap و backend enforcement Taskهای بعدی استفاده شود؛ اجرای آزمون JVM پس از رفع loopback لازم است.
- Final status: DONE
