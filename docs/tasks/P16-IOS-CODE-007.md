# P16-IOS-CODE-007 — Universal Links و callback opaque
...
- Depends on: P16-IOS-SEC-006
- Blocks: P16-IOS-LEGAL-008
- Requirement source: Master checklist row P16-IOS-CODE-007 و Source audit بخش IOS

## هدف قابل اندازه‌گیری
Universal Links و callback opaque

## خروجی مورد انتظار
cold/warm/killed + server verify
...
- معیار اختصاصی: cold/warm/killed + server verify
...
- انتظار: cold/warm/killed + server verify
...
## Evidence
- مسیر: docs/evidence/P16-IOS-CODE-007/
