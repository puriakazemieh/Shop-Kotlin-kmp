# P07-MIGRATION-CODE-018 — mapping `(sourceSiteUuid, sourceObjectId)` و two-pass relations
...
- Phase/Area/Type: P07 / MIGRATION / CODE
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P07-MIGRATION-DATA-017
- Blocks: P07-MIGRATION-CODE-019
- Requirement source: Master checklist row P07-MIGRATION-CODE-018 و Source audit بخش MIGRATION

## هدف قابل اندازه‌گیری
mapping `(sourceSiteUuid, sourceObjectId)` و two-pass relations

## خروجی مورد انتظار
import دوم update، نه duplicate
...
- Dependencyها: P07-MIGRATION-DATA-017
...
- معیار اختصاصی: import دوم update، نه duplicate
...
- انتظار: import دوم update، نه duplicate
...
## Evidence
- مسیر: docs/evidence/P07-MIGRATION-CODE-018/
...
## Completion record
- Started at: 2026-09-08T10:14:14
- Completed at: 2026-09-08T10:14:57
- Changed files: wordpress/carmilla-bridge/includes/Migration/Migrator.php, wordpress/carmilla-bridge/includes/Migration/Import_Command.php, wordpress/carmilla-bridge/includes/class-cb-standalone-boot.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: AWAITING_MANUAL_QA
- Evidence paths: docs/evidence/P07-MIGRATION-CODE-018/summary.md
