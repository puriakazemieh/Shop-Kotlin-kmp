# P02-CORE-CODE-015 — dependency inversionهای navigation/profile/admin به‌صورت Taskهای کوچک
...
- Requirement source: Master checklist row P02-CORE-CODE-015 و Source audit بخش CORE

## هدف قابل اندازه‌گیری
dependency inversionهای navigation/profile/admin به‌صورت Taskهای کوچک

## خروجی مورد انتظار
architecture test مانع import معکوس جدید شود
...
- Dependencyها: P02-ARCH-CODE-014
...
- معیار اختصاصی: architecture test مانع import معکوس جدید شود
...
- انتظار: architecture test مانع import معکوس جدید شود
...
## Evidence
- مسیر: docs/evidence/P02-CORE-CODE-015/
...
## Completion record
- Started at: 2026-08-26T11:45:00+03:30
- Completed at: 2026-08-26T11:47:00+03:30
- Changed files: docs/tasks/P02-CORE-CODE-015A.md, docs/tasks/P02-CORE-CODE-015B.md, docs/tasks.md
- Commands and exit codes: N/A
- Manual tester/date/result: N/A
- Evidence paths: docs/evidence/P02-CORE-CODE-015/EVIDENCE.md
