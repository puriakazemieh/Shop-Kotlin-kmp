# P03-ANDROID-CODE-017 — dimension backend فقط `wordpress/spring`؛ tenant config جدا
...
- Depends on: P03-WPTHEME-CODE-016
- Blocks: P03-MIGRATION-DATA-018
- Requirement source: Master checklist row P03-ANDROID-CODE-017 و Source audit بخش ANDROID

## هدف قابل اندازه‌گیری
dimension backend فقط `wordpress/spring`؛ tenant config جدا

## خروجی مورد انتظار
دو profile build؛ شش brand flavor حذف مرحله‌ای
...
- Dependencyها: P03-WPTHEME-CODE-016
...
- معیار اختصاصی: دو profile build؛ شش brand flavor حذف مرحله‌ای
...
- انتظار: دو profile build؛ شش brand flavor حذف مرحله‌ای
...
## Evidence
- مسیر: docs/evidence/P03-ANDROID-CODE-017/
