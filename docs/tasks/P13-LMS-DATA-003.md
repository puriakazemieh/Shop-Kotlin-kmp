# P13-LMS-DATA-003 — schema/migration برای Course،Section،Lesson،Enrollment،Progress
...
- Status: TODO
- Phase/Area/Type: P13 / LMS / DATA
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: AI
- Completion authority: BOTH
- Depends on: P13-LMS-ADR-002
- Blocks: P13-LMS-DATA-004
- Requirement source: Master checklist row P13-LMS-DATA-003 و Source audit بخش LMS

## هدف قابل اندازه‌گیری
schema/migration برای Course،Section،Lesson،Enrollment،Progress

## خروجی مورد انتظار
install/upgrade/rollback روی DB واقعی تست شود
...
- معیار اختصاصی: install/upgrade/rollback روی DB واقعی تست شود
...
- انتظار: install/upgrade/rollback روی DB واقعی تست شود
...
## Evidence
- مسیر: docs/evidence/P13-LMS-DATA-003/
