# P02-CORE-CODE-005A — conventionهای Android/KMP/Compose/test مرحله‌ای اعمال شوند
...
- Blocks: P02-CORE-CODE-005B
- Requirement source: Master checklist row P02-CORE-CODE-005A و Source audit بخش CORE
...
## Evidence
- مسیر: docs/evidence/P02-CORE-CODE-005A/
