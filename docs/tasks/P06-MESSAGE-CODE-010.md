# P06-MESSAGE-CODE-010 — OTP flow به ProviderResult واقعی متصل شود
...
- Depends on: P06-MESSAGE-CODE-009
- Blocks: P06-MESSAGE-CODE-011
- Requirement source: Master checklist row P06-MESSAGE-CODE-010 و Source audit بخش MESSAGE

## هدف قابل اندازه‌گیری
OTP flow به ProviderResult واقعی متصل شود

## خروجی مورد انتظار
`sent=true` فقط پس از queue/provider acceptance
...
- Dependencyها: P06-MESSAGE-CODE-009
...
- معیار اختصاصی: `sent=true` فقط پس از queue/provider acceptance
...
- انتظار: `sent=true` فقط پس از queue/provider acceptance
...
## Evidence
- مسیر: docs/evidence/P06-MESSAGE-CODE-010/
...
## Completion record
- Started at: 2026-09-07T16:48:04
- Completed at: 2026-09-07T16:49:26
- Changed files: wordpress/carmilla-bridge/includes/class-cb-auth-controller.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P06-MESSAGE-CODE-010/summary.md
