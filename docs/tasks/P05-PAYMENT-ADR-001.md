# P05-PAYMENT-ADR-001 — contract `PaymentProvider` و capability matrix تصویب شود
...
contract `PaymentProvider` و capability matrix تصویب شود

## خروجی مورد انتظار
create/verify/query/reverse/refund/deliver/settlement
...
- معیار اختصاصی: create/verify/query/reverse/refund/deliver/settlement
...
- انتظار: create/verify/query/reverse/refund/deliver/settlement
