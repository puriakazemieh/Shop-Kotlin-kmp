# P00-CORE-DISC-006 — snapshot قرارداد API فعلی KMP/WordPress/Spring و mismatchها تهیه شود
...
- Blocks: P00-QA-DISC-007
- Requirement source: Master checklist row P00-CORE-DISC-006 و Source audit بخش CORE

## هدف قابل اندازه‌گیری
snapshot قرارداد API فعلی KMP/WordPress/Spring و mismatchها تهیه شود

## خروجی مورد انتظار
response/schema نمونه redacted؛ endpointهای `/api` و deep link mismatch ثبت شوند
...
- Dependencyها: P00-MANIFEST-DISC-005
...
- معیار اختصاصی: response/schema نمونه redacted؛ endpointهای `/api` و deep link mismatch ثبت شوند
...
- انتظار: response/schema نمونه redacted؛ endpointهای `/api` و deep link mismatch ثبت شوند
...
## Evidence
- مسیر: docs/evidence/P00-CORE-DISC-006/
