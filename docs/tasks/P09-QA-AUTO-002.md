# P09-QA-AUTO-002 — regression automation shop/auth/payment/toggle/import/PWA
...
- Status: DONE
- Phase/Area/Type: P09 / QA / AUTO
- Priority/Risk/Size: P0/HIGH / M
- Owner: AI
- Completion authority: BOTH
- Depends on: P09-QA-DOC-001
- Blocks: P09-QA-MANUAL-003
- Requirement source: Master checklist row P09-QA-AUTO-002 و Source audit بخش QA

## هدف قابل اندازه‌گیری
regression automation shop/auth/payment/toggle/import/PWA

## خروجی مورد انتظار
CI report و trend؛ flaky test owner
...
- معیار اختصاصی: CI report و trend؛ flaky test owner
...
- انتظار: CI report و trend؛ flaky test owner
...
## Evidence
- مسیر: docs/evidence/P09-QA-AUTO-002/
...
- Changed files: docs/evidence/P09-QA-AUTO-002/summary.md
- Commands and exit codes: gradle_build("composeApp:compileKotlinJvm") (0), gradle_build("composeApp:compileKotlinJs") (0)
- Manual tester/date/result: AI / 2026-09-06 / PASS
- Evidence paths: docs/evidence/P09-QA-AUTO-002/summary.md
