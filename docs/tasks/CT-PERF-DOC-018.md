# CT-PERF-DOC-018 — ایجاد و نگه‌داری artifact: `docs/performance/BUDGETS.md`
...
- Status: TODO
- Phase/Area/Type: CONTROL / PERF / DOC
...
- Requirement source: Master checklist row CT-PERF-DOC-018 و Source audit بخش PERF

## هدف قابل اندازه‌گیری
ایجاد و نگه‌داری artifact: `docs/performance/BUDGETS.md`

## خروجی مورد انتظار
size/startup/API/Core Web Vitals/DB budget
...
- معیار اختصاصی: size/startup/API/Core Web Vitals/DB budget
...
- انتظار: size/startup/API/Core Web Vitals/DB budget
...
## Evidence
- مسیر: docs/evidence/CT-PERF-DOC-018/
