...
# P14-CLINIC-CODE-033 — تفکیک قابلیت نوبت‌دهی از خدمات و اطلاعات مشاوره
...
- Depends on: P14-CLINIC-DATA-005, P04-ENTITLEMENT-DATA-039
- Blocks: P14-CLINIC-CODE-006
...
شناسه‌های قرارداد039 را به registry/schema/API/UI موجود map کن؛ booking بتواند بدون Psych و پرونده بالینی ارائه شود. معرفی مشاور و جلسه/ارتباط خصوصی capability جدا داشته باشند؛ alias قدیمی مهاجرت سازگار بگیرد.
...
- مستندات قرارداد مرتبط و `docs/evidence/P14-CLINIC-CODE-033/**`؛ row/card/checklist همین Task.
...
SKU booking-only رزرو دارد و هیچ psych/note/file خصوصی فعال نیست؛ consultation ترکیب وابستگی معتبر؛ Theme/Plugin/client و API همسو.
...
- موفقیت: SKU booking-only رزرو دارد و هیچ psych/note/file خصوصی فعال نیست؛ consultation ترکیب وابستگی معتبر؛ Theme/Plugin/client و API همسو.
...
- مسیر: `docs/evidence/P14-CLINIC-CODE-033/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
