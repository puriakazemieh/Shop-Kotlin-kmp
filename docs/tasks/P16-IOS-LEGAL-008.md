# P16-IOS-LEGAL-008 — طبقه‌بندی محصول و مسیر پرداخت طبق قواعد جاری Store
...
- Status: TODO
- Phase/Area/Type: P16 / IOS / LEGAL
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: HUMAN/EXTERNAL
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P16-IOS-CODE-007
- Blocks: P16-IOS-CODE-009
- Requirement source: Master checklist row P16-IOS-LEGAL-008 و Source audit بخش IOS

## هدف قابل اندازه‌گیری
طبقه‌بندی محصول و مسیر پرداخت طبق قواعد جاری Store

## خروجی مورد انتظار
review رسمی و decision record برای هر SKU
...
- معیار اختصاصی: review رسمی و decision record برای هر SKU
...
- انتظار: review رسمی و decision record برای هر SKU
...
## Evidence
- مسیر: docs/evidence/P16-IOS-LEGAL-008/
