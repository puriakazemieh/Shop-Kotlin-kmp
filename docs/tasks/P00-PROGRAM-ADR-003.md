# P00-PROGRAM-ADR-003 — scope اولین release روی `shop-only + WordPress + Theme + PWA` freeze شود
...
- Status: DONE
- Phase/Area/Type: P00 / PROGRAM / ADR
- Priority/Risk/Size: P0/MEDIUM / XS
- Owner: BOTH
- Completion authority: BOTH
- Depends on: P00-PROGRAM-DISC-002
- Blocks: P00-ARCH-ADR-004
- Requirement source: Master checklist row P00-PROGRAM-ADR-003 و Source audit بخش PROGRAM

## هدف قابل اندازه‌گیری
scope اولین release روی `shop-only + WordPress + Theme + PWA` freeze شود

## خروجی مورد انتظار
ADR با in-scope/out-of-scope؛ LMS/Clinic/Spring/iOS/Desktop صریحاً خارج نسخه اول
...
- Dependencyها: P00-PROGRAM-DISC-002
...
- معیار اختصاصی: ADR با in-scope/out-of-scope؛ LMS/Clinic/Spring/iOS/Desktop صریحاً خارج نسخه اول
...
- انتظار: ADR با in-scope/out-of-scope؛ LMS/Clinic/Spring/iOS/Desktop صریحاً خارج نسخه اول
...
## Evidence
- مسیر: docs/evidence/P00-PROGRAM-ADR-003/
...
- Evidence paths: docs/evidence/P00-PROGRAM-ADR-003/
