# P16-IOS-OPS-018 — archive/export/upload/TestFlight pipeline
...
archive/export/upload/TestFlight pipeline

## خروجی مورد انتظار
artifact checksum/version/symbol retention
...
- معیار اختصاصی: artifact checksum/version/symbol retention
...
- انتظار: artifact checksum/version/symbol retention
