# P08-PWA-ADR-001 — معماری استقرار مستقل Web/PWA و دو backend
...
- Blocks: P08-PWA-CODE-002
- Requirement source: Master checklist row P08-PWA-ADR-001 و Source audit بخش PWA
...
Web/PWA خروجی مستقل با پیکربندی trusted باشد؛ استقرار root/subdirectory یا origin جدا و WordPress /app/ بررسی شود. WORDPRESS سه host mode دارد؛ SPRING بدون WordPress کار می‌کند.
...
3. قرارداد/مستند این کارت را با موارد زیر تطبیق و تصمیم‌های باز را ownerدار ثبت کن: Web/PWA خروجی مستقل با پیکربندی trusted باشد؛ استقرار root/subdirectory یا origin جدا و WordPress /app/ بررسی شود. WORDPRESS سه host mode دارد؛ SPRING بدون WordPress کار می‌کند.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: CORS/cookie/auth/cache/SEO boundary برای هر استقرار ثبت شود؛ آمادگی production اتصال Spring فقط با Gate P15 ادعا شود.
...
- معیار اختصاصی: CORS/cookie/auth/cache/SEO boundary برای هر استقرار ثبت شود؛ آمادگی production اتصال Spring فقط با Gate P15 ادعا شود.
...
- معیار موفقیت: CORS/cookie/auth/cache/SEO boundary برای هر استقرار ثبت شود؛ آمادگی production اتصال Spring فقط با Gate P15 ادعا شود.
...
## Evidence
- مسیر: docs/evidence/P08-PWA-ADR-001/
