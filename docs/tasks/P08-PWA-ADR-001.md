# P08-PWA-ADR-001 — تصمیم same-origin `/app/` در برابر subdomain و SEO boundary
...
تصمیم same-origin `/app/` در برابر subdomain و SEO boundary

## خروجی مورد انتظار
CORS/cookie/auth/cache/deploy tradeoff ثبت
...
- معیار اختصاصی: CORS/cookie/auth/cache/deploy tradeoff ثبت
...
- انتظار: CORS/cookie/auth/cache/deploy tradeoff ثبت
