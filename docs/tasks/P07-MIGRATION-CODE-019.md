# P07-MIGRATION-CODE-019 — delta import و URL/domain/media rewrite
...
- Depends on: P07-MIGRATION-CODE-018
- Blocks: P07-MIGRATION-DATA-020
- Requirement source: Master checklist row P07-MIGRATION-CODE-019 و Source audit بخش MIGRATION

## هدف قابل اندازه‌گیری
delta import و URL/domain/media rewrite

## خروجی مورد انتظار
count/hash/relation و مقصد URL صحیح
...
- Dependencyها: P07-MIGRATION-CODE-018
...
- معیار اختصاصی: count/hash/relation و مقصد URL صحیح
...
- انتظار: count/hash/relation و مقصد URL صحیح
...
## Evidence
- مسیر: docs/evidence/P07-MIGRATION-CODE-019/
...
## Completion record
- Started at: 2026-09-08T10:15:40
- Completed at: 2026-09-08T10:16:24
- Changed files: wordpress/carmilla-bridge/includes/Migration/Migrator.php, wordpress/carmilla-bridge/includes/Migration/Import_Command.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: AWAITING_MANUAL_QA
- Evidence paths: docs/evidence/P07-MIGRATION-CODE-019/summary.md
