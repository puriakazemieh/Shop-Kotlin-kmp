# P01-WPPLUGIN-SEC-013 — role/capability matrix granular؛ `shop_manager` ادمین سلامت نباشد
...
- Depends on: P01-WPPLUGIN-SEC-012
- Blocks: P01-WPPLUGIN-SEC-014
- Requirement source: Master checklist row P01-WPPLUGIN-SEC-013 و Source audit بخش WPPLUGIN
...
- Dependencyها: P01-WPPLUGIN-SEC-012
...
- معیار اختصاصی: تست نقش‌ها روی همه endpointهای حساس
...
- انتظار: تست نقش‌ها روی همه endpointهای حساس
...
## Evidence
- مسیر: docs/evidence/P01-WPPLUGIN-SEC-013/
