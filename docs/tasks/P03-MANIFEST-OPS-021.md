# P03-MANIFEST-OPS-021 — aliasهای legacy با deprecation/telemetry نگه داشته شوند
...
- معیار اختصاصی: یک client cycle؛ حذف در Task جدا
...
- انتظار: یک client cycle؛ حذف در Task جدا
...
## Evidence
- مسیر: docs/evidence/P03-MANIFEST-OPS-021/
