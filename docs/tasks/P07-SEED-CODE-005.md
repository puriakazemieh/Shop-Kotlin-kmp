# P07-SEED-CODE-005 — upsert با stable key/hash و حفظ تغییر مشتری
...
- Depends on: P07-SEED-CODE-004
- Blocks: P07-SEED-CODE-006
- Requirement source: Master checklist row P07-SEED-CODE-005 و Source audit بخش SEED

## هدف قابل اندازه‌گیری
upsert با stable key/hash و حفظ تغییر مشتری

## خروجی مورد انتظار
اجرای دوم duplicate صفر
...
- Dependencyها: P07-SEED-CODE-004
...
- معیار اختصاصی: اجرای دوم duplicate صفر
...
- انتظار: اجرای دوم duplicate صفر
...
## Evidence
- مسیر: docs/evidence/P07-SEED-CODE-005/
...
## Completion record
- Started at: 2026-09-07T17:58:35
- Completed at: 2026-09-07T17:59:07
...
- Evidence paths: docs/evidence/P07-SEED-CODE-005/summary.md
