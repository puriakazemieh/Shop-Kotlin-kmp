# P13-LMS-DATA-017 — Seed Pack آموزشی فاز ۷ با schema نهایی همگام شود
...
- Depends on: P13-LMS-CODE-016
- Blocks: P13-LMS-CODE-018
- Requirement source: Master checklist row P13-LMS-DATA-017 و Source audit بخش LMS

## هدف قابل اندازه‌گیری
Seed Pack آموزشی فاز ۷ با schema نهایی همگام شود

## خروجی مورد انتظار
dry-run/upsert/resume/rollback دو بار پاس شود
...
- معیار اختصاصی: dry-run/upsert/resume/rollback دو بار پاس شود
...
- انتظار: dry-run/upsert/resume/rollback دو بار پاس شود
...
## Evidence
- مسیر: docs/evidence/P13-LMS-DATA-017/
