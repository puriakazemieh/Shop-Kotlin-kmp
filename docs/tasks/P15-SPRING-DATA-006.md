# P15-SPRING-DATA-006 — PostgreSQL production profile و Flyway-only migration
...
- Status: TODO
- Phase/Area/Type: P15 / SPRING / DATA
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH
- Depends on: P15-SPRING-CODE-005
- Blocks: P15-SPRING-DATA-007
- Requirement source: Master checklist row P15-SPRING-DATA-006 و Source audit بخش SPRING

## هدف قابل اندازه‌گیری
PostgreSQL production profile و Flyway-only migration

## خروجی مورد انتظار
fresh/upgrade/rollback-plan روی snapshot
...
- Dependencyها: P15-SPRING-CODE-005
...
- معیار اختصاصی: fresh/upgrade/rollback-plan روی snapshot
...
- انتظار: fresh/upgrade/rollback-plan روی snapshot
...
## Evidence
- مسیر: docs/evidence/P15-SPRING-DATA-006/
