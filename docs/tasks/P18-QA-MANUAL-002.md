...
# P18-QA-MANUAL-002 — پذیرش نهایی پوسته مستقل و چهار بیلدر انتخابی
...
روی WordPress staging با Plugin Carmilla نصب‌نشده،ZIP پایه و ZIP فیچردار از manifest مشخص را تحویل بگیر؛ قابلیت‌های مجاز و هر چهار builder target را با بسته‌های مناسب از خود پوسته استفاده کن.
...
- `docs/qa/**`
- `docs/evidence/P18-QA-MANUAL-002/**`
- `.github/workflows/** فقط orchestration تست`
- `tools/test-env/** فقط fixture و harness`

- مستندات قرارداد مرتبط و `docs/evidence/P18-QA-MANUAL-002/**`؛ row/card/checklist همین Task.
...
کجا: پنل/سایت پوسته و خروجی‌های نصب‌شده. چگونه: فروشگاه/رزرو/مشاوره مجاز را طی کن؛ falseها را در ZIP و UI بررسی؛ از پنل پوسته Android/iOS/Desktop/PWA بساز و دریافت کن. موفقیت: استقلال کامل،output واقعی و صحیح،toggle مجاز،عدم نصب افزونه همراه.
...
- موفقیت: کجا: پنل/سایت پوسته و خروجی‌های نصب‌شده. چگونه: فروشگاه/رزرو/مشاوره مجاز را طی کن؛ falseها را در ZIP و UI بررسی؛ از پنل پوسته Android/iOS/Desktop/PWA بساز و دریافت کن. موفقیت: استقلال کامل،output واقعی و صحیح،toggle مجاز،عدم نصب افزونه همراه.
...
- مسیر: `docs/evidence/P18-QA-MANUAL-002/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
