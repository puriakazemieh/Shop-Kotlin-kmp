# P00-MANIFEST-DISC-005 — catalog همه featureهای فعلی و consumerهای UI/route/API/DI تهیه شود
...
- Blocks: P00-CORE-DISC-006
- Requirement source: Master checklist row P00-MANIFEST-DISC-005 و Source audit بخش MANIFEST

## هدف قابل اندازه‌گیری
catalog همه featureهای فعلی و consumerهای UI/route/API/DI تهیه شود

## خروجی مورد انتظار
فهرست path/line و dependency graph؛ feature بدون owner مشخص نباشد
...
- معیار اختصاصی: فهرست path/line و dependency graph؛ feature بدون owner مشخص نباشد
...
- انتظار: فهرست path/line و dependency graph؛ feature بدون owner مشخص نباشد
...
## Evidence
- مسیر: docs/evidence/P00-MANIFEST-DISC-005/
