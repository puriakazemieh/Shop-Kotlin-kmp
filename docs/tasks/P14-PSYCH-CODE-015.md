# P14-PSYCH-CODE-015 — قالب نتیجه،دامنه تفسیر و disclaimer بالینی
...
- Depends on: P14-PSYCH-CODE-014
- Blocks: P14-PSYCH-CODE-016
- Requirement source: Master checklist row P14-PSYCH-CODE-015 و Source audit بخش PSYCH

## هدف قابل اندازه‌گیری
قالب نتیجه،دامنه تفسیر و disclaimer بالینی

## خروجی مورد انتظار
مسئول بالینی هر متن و threshold را تأیید کند
...
- Dependencyها: P14-PSYCH-CODE-014
...
- معیار اختصاصی: مسئول بالینی هر متن و threshold را تأیید کند
...
- انتظار: مسئول بالینی هر متن و threshold را تأیید کند
...
## Evidence
- مسیر: docs/evidence/P14-PSYCH-CODE-015/
