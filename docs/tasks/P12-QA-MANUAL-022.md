...
# P12-QA-MANUAL-022 — تحویل واقعی اپ‌ساز از هر دو محصول مستقل
...
- Status: TODO
- Phase/Area/Type: P12 / QA / MANUAL
- Priority/Risk/Size: P0 / HIGH / M
- Owner: HUMAN
- Completion authority: مطابق نوع خروجی؛ UI/network/migration با تأیید انسانی
- Depends on: P12-QA-AUTO-016, P12-BUILDER-CODE-021
- Blocks: P12-SECURITY-SEC-017
...
روی دو سایت synthetic، Theme-only و Plugin-only با قالب ثالث، Android و Web/PWA واقعی بساز و تحویل بگیر؛ co-install یک job را از هر دو پنل مشاهده کن.
...
- `docs/evidence/P12-QA-MANUAL-022/**`
- `docs/tasks/P12-QA-MANUAL-022.md`
- `docs/tasks.md`
- `docs/MASTER_IMPLEMENTATION_CHECKLIST_FA.md`

- مستندات قرارداد مرتبط و `docs/evidence/P12-QA-MANUAL-022/**`؛ row/card/checklist همین Task.
...
کجا: پنل App Builder هر میزبان و دستگاه Android/مرورگر. چگونه: خرید مجاز→branding→build→download→install، سپس هدف غیرمجاز/retry. موفقیت: artifact صحیح سایت و برند، منع هدف نخریده، یک job؛ شواهد و تأیید انسانی.
...
- موفقیت: کجا: پنل App Builder هر میزبان و دستگاه Android/مرورگر. چگونه: خرید مجاز→branding→build→download→install، سپس هدف غیرمجاز/retry. موفقیت: artifact صحیح سایت و برند، منع هدف نخریده، یک job؛ شواهد و تأیید انسانی.
...
- مسیر: `docs/evidence/P12-QA-MANUAL-022/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
