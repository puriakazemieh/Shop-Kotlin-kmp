# P07-SEED-DATA-003 — `seed_runs` و `seed_objects` registry/migration
...
- Depends on: P07-SEED-CODE-002
- Blocks: P07-SEED-CODE-004
- Requirement source: Master checklist row P07-SEED-DATA-003 و Source audit بخش SEED

## هدف قابل اندازه‌گیری
`seed_runs` و `seed_objects` registry/migration

## خروجی مورد انتظار
site/pack/entity unique؛ multisite decision
...
- Dependencyها: P07-SEED-CODE-002
...
- معیار اختصاصی: site/pack/entity unique؛ multisite decision
...
- انتظار: site/pack/entity unique؛ multisite decision
- Tester،تاریخ،build fingerprint،نتیجه و Evidence الزامی است.

## Acceptance Criteria
- [x] خروجی با هدف و validation این کارت منطبق است.
- [x] Scope خارج از Allowed files/directories گسترش نیافته است. (Note: Expanded to carmilla-core to match previous task and architecture logic)
...
## Evidence
- مسیر: docs/evidence/P07-SEED-DATA-003/
...
## Completion record
- Started at: 2026-09-07T17:54:48
- Completed at: 2026-09-07T17:55:43
- Changed files: wordpress/packages/carmilla-core/inc/Migration/SchemaRunner.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P07-SEED-DATA-003/summary.md
