# P11-QA-MANUAL-016 — RTL/font 200%/TalkBack/light/dark
...
- Depends on: P11-QA-MANUAL-015
- Blocks: P11-ANDROID-OPS-017
- Requirement source: Master checklist row P11-QA-MANUAL-016 و Source audit بخش QA

## هدف قابل اندازه‌گیری
RTL/font 200%/TalkBack/light/dark

## خروجی مورد انتظار
golden flows evidence
...
- Dependencyها: P11-QA-MANUAL-015
...
- معیار اختصاصی: golden flows evidence
...
## Evidence
- مسیر: docs/evidence/P11-QA-MANUAL-016/
