# P06-QA-AUTO-013 — تست provider، queue و خاموشی قابلیت در سه حالت میزبان
...
- Phase/Area/Type: P06 / QA / AUTO
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: AI
- Completion authority: BOTH
- Depends on: P06-MESSAGE-CODE-012
- Blocks: P06-QA-MANUAL-014
- Requirement source: Master checklist row P06-QA-AUTO-013 و Source audit بخش QA
...
تست‌های Generic HTTP، wp_mail، retry، SSRF و secret masking را با fake provider روی Theme-only، Plugin-only و co-install اجرا کن.

## خروجی مورد انتظار
یک ارسال برای event تکراری؛ job غیرمجاز/قابلیت خاموش رد شود؛ secret و PII در report صفر.
...
- Dependencyها: P06-MESSAGE-CODE-012
...
3. تغییر محدود این کارت را در مسیرهای مجاز پیاده یا آزمون کن: تست‌های Generic HTTP، wp_mail، retry، SSRF و secret masking را با fake provider روی Theme-only، Plugin-only و co-install اجرا کن.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: یک ارسال برای event تکراری؛ job غیرمجاز/قابلیت خاموش رد شود؛ secret و PII در report صفر.
...
- معیار اختصاصی: یک ارسال برای event تکراری؛ job غیرمجاز/قابلیت خاموش رد شود؛ secret و PII در report صفر.
...
- معیار موفقیت: یک ارسال برای event تکراری؛ job غیرمجاز/قابلیت خاموش رد شود؛ secret و PII در report صفر.
...
## Acceptance Criteria
- [x] یک ارسال برای event تکراری؛ job غیرمجاز/قابلیت خاموش رد شود؛ secret و PII در report صفر.
...
## Evidence
- مسیر: docs/evidence/P06-QA-AUTO-013/
...
## Completion record
- Started at: 2026-09-07T16:58:47
- Completed at: 2026-09-07T16:59:53
- Changed files: wordpress/carmilla-bridge/tests/smoke-messaging.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P06-QA-AUTO-013/summary.md
