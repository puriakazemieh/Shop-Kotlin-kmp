# P06-QA-AUTO-013 — fake provider tests برای success/timeout/4xx/5xx/retry
...
fake provider tests برای success/timeout/4xx/5xx/retry

## خروجی مورد انتظار
secret snapshot tests
...
- معیار اختصاصی: secret snapshot tests
