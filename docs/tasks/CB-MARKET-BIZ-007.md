# CB-MARKET-BIZ-007 — ۱۰–۱۵ مصاحبه مسئله قبل از تثبیت package/pricing
...
- Requirement source: Master checklist row CB-MARKET-BIZ-007 و Source audit بخش MARKET

## هدف قابل اندازه‌گیری
۱۰–۱۵ مصاحبه مسئله قبل از تثبیت package/pricing

## خروجی مورد انتظار
transcript خلاصه و بدون داده حساس؛ الگوی درد تکرارشونده
...
- معیار اختصاصی: transcript خلاصه و بدون داده حساس؛ الگوی درد تکرارشونده
...
- انتظار: transcript خلاصه و بدون داده حساس؛ الگوی درد تکرارشونده
...
## Evidence
- مسیر: docs/evidence/CB-MARKET-BIZ-007/
