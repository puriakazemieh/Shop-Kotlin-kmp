# P08-PWA-CODE-008 — logout/private cache purge و session expiry
...
- Depends on: P08-PWA-CODE-007
- Blocks: P08-PWA-CODE-009
- Requirement source: Master checklist row P08-PWA-CODE-008 و Source audit بخش PWA

## هدف قابل اندازه‌گیری
logout/private cache purge و session expiry

## خروجی مورد انتظار
logout سپس offline داده خصوصی نشان ندهد
...
- معیار اختصاصی: logout سپس offline داده خصوصی نشان ندهد
...
- انتظار: logout سپس offline داده خصوصی نشان ندهد
...
## Evidence
- مسیر: docs/evidence/P08-PWA-CODE-008/
...
## Completion record
- Started at: 2026-09-08T11:21:48
- Completed at: 2026-09-08T11:28:18
- Changed files: core/data/src/commonMain/kotlin/com/kazemieh/data/auth/repository/AuthRepositoryImpl.kt, composeApp/src/webMain/kotlin/com/kazemieh/shop/main.kt
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: AI / 2026-09-08 / PASS
- Evidence paths: docs/evidence/P08-PWA-CODE-008/summary.md
