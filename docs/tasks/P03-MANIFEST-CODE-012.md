# P03-MANIFEST-CODE-012 — shadow mode و telemetry اختلاف flag قدیم/جدید
...
shadow mode و telemetry اختلاف flag قدیم/جدید

## خروجی مورد انتظار
ابتدا رفتار عوض نشود؛ اختلاف‌ها redacted
...
- معیار اختصاصی: ابتدا رفتار عوض نشود؛ اختلاف‌ها redacted
...
- انتظار: ابتدا رفتار عوض نشود؛ اختلاف‌ها redacted
...
## Evidence
- مسیر: docs/evidence/P03-MANIFEST-CODE-012/
