# P12-BUILDER-OPS-009 — artifact storage، checksum، SBOM، expiry و malware policy
...
artifact storage، checksum، SBOM، expiry و malware policy

## خروجی مورد انتظار
tamper/expired/unauthorized download رد
...
- معیار اختصاصی: tamper/expired/unauthorized download رد
...
- انتظار: tamper/expired/unauthorized download رد
...
## Evidence
- مسیر: docs/evidence/P12-BUILDER-OPS-009/
