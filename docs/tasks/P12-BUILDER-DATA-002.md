# P12-BUILDER-DATA-002 — Project/Tenant/BuildJob/Artifact/Template/Entitlement model
...
Project/Tenant/BuildJob/Artifact/Template/Entitlement model
...
- معیار اختصاصی: state machine/idempotency/audit
...
- انتظار: state machine/idempotency/audit
