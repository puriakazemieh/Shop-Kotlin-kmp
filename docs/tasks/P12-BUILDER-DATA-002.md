# P12-BUILDER-DATA-002 — مدل پروژه، BuildJob و entitlement با منشأ محصول
...
- Status: TODO
- Phase/Area/Type: P12 / BUILDER / DATA
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH
- Depends on: P12-BUILDER-ADR-001
- Blocks: P12-BUILDER-CODE-003
- Requirement source: Master checklist row P12-BUILDER-DATA-002 و Source audit بخش BUILDER
...
Project/Tenant/BuildJob/Artifact/Template/Entitlement همراه product source، SKU، backend، target و BuildSpec version مدل شود؛ حق feature، حق build و حق target جدا بمانند.

## خروجی مورد انتظار
site/project binding و provenance؛ idempotency/audit؛ نصب هم‌زمان یا ارسال JSON feature مجوز تازه ایجاد نکند.
...
- Dependencyها: P12-BUILDER-ADR-001
...
3. تغییر محدود این کارت را در مسیرهای مجاز پیاده یا آزمون کن: Project/Tenant/BuildJob/Artifact/Template/Entitlement همراه product source، SKU، backend، target و BuildSpec version مدل شود؛ حق feature، حق build و حق target جدا بمانند.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: site/project binding و provenance؛ idempotency/audit؛ نصب هم‌زمان یا ارسال JSON feature مجوز تازه ایجاد نکند.
...
- معیار اختصاصی: site/project binding و provenance؛ idempotency/audit؛ نصب هم‌زمان یا ارسال JSON feature مجوز تازه ایجاد نکند.
...
- معیار موفقیت: site/project binding و provenance؛ idempotency/audit؛ نصب هم‌زمان یا ارسال JSON feature مجوز تازه ایجاد نکند.
...
## Evidence
- مسیر: docs/evidence/P12-BUILDER-DATA-002/
