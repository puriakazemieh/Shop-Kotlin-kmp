# P13-LMS-DOC-026 — راهنمای مدیر/مدرس/دانشجو و troubleshooting
...
- Status: TODO
- Phase/Area/Type: P13 / LMS / DOC
- Priority/Risk/Size: P0/MEDIUM / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH
- Depends on: P13-LMS-BIZ-025
- Blocks: P13-LMS-GATE-027
- Requirement source: Master checklist row P13-LMS-DOC-026 و Source audit بخش LMS

## هدف قابل اندازه‌گیری
راهنمای مدیر/مدرس/دانشجو و troubleshooting

## خروجی مورد انتظار
کاربر آزمایشی با راهنما golden flow را تمام کند
...
- معیار اختصاصی: کاربر آزمایشی با راهنما golden flow را تمام کند
...
- انتظار: کاربر آزمایشی با راهنما golden flow را تمام کند
...
## Evidence
- مسیر: docs/evidence/P13-LMS-DOC-026/
