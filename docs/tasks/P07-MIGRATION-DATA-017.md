# P07-MIGRATION-DATA-017 — export NDJSON + media manifest + checksums
...
- Depends on: P07-MIGRATION-ADR-016
- Blocks: P07-MIGRATION-CODE-018
- Requirement source: Master checklist row P07-MIGRATION-DATA-017 و Source audit بخش MIGRATION

## هدف قابل اندازه‌گیری
export NDJSON + media manifest + checksums

## خروجی مورد انتظار
PHP/serialized object نامطمئن اجرا نشود
...
- Dependencyها: P07-MIGRATION-ADR-016
...
- معیار اختصاصی: PHP/serialized object نامطمئن اجرا نشود
...
- انتظار: PHP/serialized object نامطمئن اجرا نشود
...
## Evidence
- مسیر: docs/evidence/P07-MIGRATION-DATA-017/
...
## Completion record
- Started at: 2026-09-08T10:11:26
- Completed at: 2026-09-08T10:13:29
- Changed files: wordpress/carmilla-bridge/includes/Migration/Export_Command.php, wordpress/carmilla-bridge/includes/class-cb-standalone-boot.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: AWAITING_MANUAL_QA
- Evidence paths: docs/evidence/P07-MIGRATION-DATA-017/summary.md
