# CB-SALES-BIZ-033 — pipeline lead→qualified→demo→trial→paid→renewed
...
- Status: TODO
- Phase/Area/Type: CONTROL / SALES / BIZ
...
- Requirement source: Master checklist row CB-SALES-BIZ-033 و Source audit بخش SALES

## هدف قابل اندازه‌گیری
pipeline lead→qualified→demo→trial→paid→renewed

## خروجی مورد انتظار
تعریف stage و lost reason یکسان
...
- معیار اختصاصی: تعریف stage و lost reason یکسان
...
- انتظار: تعریف stage و lost reason یکسان
...
## Evidence
- مسیر: docs/evidence/CB-SALES-BIZ-033/
