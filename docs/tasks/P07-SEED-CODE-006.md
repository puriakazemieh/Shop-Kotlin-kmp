# P07-SEED-CODE-006 — cursor/journal/lock و resume
...
- Depends on: P07-SEED-CODE-005
- Blocks: P07-SEED-CODE-007
- Requirement source: Master checklist row P07-SEED-CODE-006 و Source audit بخش SEED

## هدف قابل اندازه‌گیری
cursor/journal/lock و resume

## خروجی مورد انتظار
قطع در ۳۰٪ → نتیجه برابر اجرای کامل
...
- Dependencyها: P07-SEED-CODE-005
...
- معیار اختصاصی: قطع در ۳۰٪ → نتیجه برابر اجرای کامل
...
- انتظار: قطع در ۳۰٪ → نتیجه برابر اجرای کامل
...
## Evidence
- مسیر: docs/evidence/P07-SEED-CODE-006/
...
## Completion record
- Started at: 2026-09-07T18:00:56
- Completed at: 2026-09-07T18:01:20
...
- Evidence paths: docs/evidence/P07-SEED-CODE-006/summary.md
