# P12-BUILDER-ADR-001 — ADR control plane، isolation و non-goals
...
- Dependencyها: P11-ANDROID-GATE-021
...
- معیار اختصاصی: هیچ Gradle/Xcode روی هاست WordPress
...
- انتظار: هیچ Gradle/Xcode روی هاست WordPress
