# P16-QA-MANUAL-017 — RTL،Dynamic Type،VoiceOver،dark mode و keyboard
...
- Depends on: P16-QA-MANUAL-016
- Blocks: P16-IOS-OPS-018
- Requirement source: Master checklist row P16-QA-MANUAL-017 و Source audit بخش QA

## هدف قابل اندازه‌گیری
RTL،Dynamic Type،VoiceOver،dark mode و keyboard
...
- Dependencyها: P16-QA-MANUAL-016
...
- معیار اختصاصی: golden flow evidence
...
## Evidence
- مسیر: docs/evidence/P16-QA-MANUAL-017/
