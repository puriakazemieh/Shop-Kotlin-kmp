...
# P04-WORDPRESS-CODE-027B — انتقال آزمون آموزشی و گواهی موجود
...
- Depends on: P04-WORDPRESS-CODE-027A
...
Quiz/Attempt/Certificate موجود و نمایش/مدیریت مرتبط را به slice مشترک منتقل کن؛ منطق نمره و permission در view کپی نشود.
...
- مستندات قرارداد مرتبط و `docs/evidence/P04-WORDPRESS-CODE-027B/**`؛ row/card/checklist همین Task.
...
fixture نسخه موجود قبل/بعد برابر؛ attempt تکراری کنترل؛ Theme و Plugin مسیر نمایش و مدیریت یکسان؛ توسعه engine جدید به P13.
...
- موفقیت: fixture نسخه موجود قبل/بعد برابر؛ attempt تکراری کنترل؛ Theme و Plugin مسیر نمایش و مدیریت یکسان؛ توسعه engine جدید به P13.
...
- مسیر: `docs/evidence/P04-WORDPRESS-CODE-027B/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
