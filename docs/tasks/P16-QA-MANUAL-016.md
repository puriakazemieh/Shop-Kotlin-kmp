# P16-QA-MANUAL-016 — iPhone کوچک/بزرگ،iPad در صورت Scope،دو نسخه iOS
...
- Status: TODO
- Phase/Area/Type: P16 / QA / MANUAL
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: HUMAN
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P16-QA-AUTO-015
- Blocks: P16-QA-MANUAL-017
- Requirement source: Master checklist row P16-QA-MANUAL-016 و Source audit بخش QA

## هدف قابل اندازه‌گیری
iPhone کوچک/بزرگ،iPad در صورت Scope،دو نسخه iOS

## خروجی مورد انتظار
install/upgrade/rotation/background/low network
...
- معیار اختصاصی: install/upgrade/rotation/background/low network
...
- انتظار: install/upgrade/rotation/background/low network
...
## Evidence
- مسیر: docs/evidence/P16-QA-MANUAL-016/
