# P07-MIGRATION-SEC-022 — denylist users/orders/payments/secrets/health data پیش‌فرض
...
- Depends on: P07-MIGRATION-SEC-021
- Blocks: P07-QA-AUTO-023
- Requirement source: Master checklist row P07-MIGRATION-SEC-022 و Source audit بخش MIGRATION

## هدف قابل اندازه‌گیری
denylist users/orders/payments/secrets/health data پیش‌فرض

## خروجی مورد انتظار
export inspection و privacy test
...
- Dependencyها: P07-MIGRATION-SEC-021
...
- معیار اختصاصی: export inspection و privacy test
...
- انتظار: export inspection و privacy test
...
## Evidence
- مسیر: docs/evidence/P07-MIGRATION-SEC-022/
...
## Completion record
- Started at: 2026-09-08T10:26:08
- Completed at: 2026-09-08T10:27:06
- Changed files: wordpress/carmilla-bridge/includes/Migration/Migration_Config.php, wordpress/carmilla-bridge/includes/Migration/Export_Command.php, wordpress/carmilla-bridge/includes/Migration/Export_Overlay_Command.php, wordpress/carmilla-bridge/includes/class-cb-standalone-boot.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: AWAITING_MANUAL_QA
- Evidence paths: docs/evidence/P07-MIGRATION-SEC-022/summary.md
