# CB-CUSTOMER-CODE-024 — هویت مشتری فقط در overlay/config/resources
...
- Status: TODO
- Phase/Area/Type: CONTROL / CUSTOMER / CODE
...
- Requirement source: Master checklist row CB-CUSTOMER-CODE-024 و Source audit بخش CUSTOMER

## هدف قابل اندازه‌گیری
هویت مشتری فقط در overlay/config/resources

## خروجی مورد انتظار
هیچ branch/source fork مشتری
...
- معیار اختصاصی: هیچ branch/source fork مشتری
...
- انتظار: هیچ branch/source fork مشتری
...
## Evidence
- مسیر: docs/evidence/CB-CUSTOMER-CODE-024/
