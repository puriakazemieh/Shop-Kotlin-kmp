...
# P18-QA-MANUAL-003 — پذیرش نهایی افزونه مستقل و چهار بیلدر انتخابی
...
- Depends on: P18-QA-MANUAL-002
- Blocks: P18-QA-MANUAL-004
...
با قالب استاندارد دیگر و بدون Carmilla Theme،ZIPهای افزونه را از manifest نصب کن؛ UI عمومی و مدیریت و هر چهار target Builder را از همان افزونه استفاده کن.
...
- `docs/qa/**`
- `docs/evidence/P18-QA-MANUAL-003/**`
- `.github/workflows/** فقط orchestration تست`
- `tools/test-env/** فقط fixture و harness`

- مستندات قرارداد مرتبط و `docs/evidence/P18-QA-MANUAL-003/**`؛ row/card/checklist همین Task.
...
کجا: صفحات عمومی و پنل افزونه. چگونه: مسیر خرید/نوبت/مشاوره مجاز و toggle؛ دریافت چهار خروجی واقعی؛ module false و درخواست غیرمجاز را بررسی. موفقیت: قالب میزبان سالم،نیاز به Carmilla Theme صفر،بسته و خروجی مطابق خرید.
...
- موفقیت: کجا: صفحات عمومی و پنل افزونه. چگونه: مسیر خرید/نوبت/مشاوره مجاز و toggle؛ دریافت چهار خروجی واقعی؛ module false و درخواست غیرمجاز را بررسی. موفقیت: قالب میزبان سالم،نیاز به Carmilla Theme صفر،بسته و خروجی مطابق خرید.
...
- مسیر: `docs/evidence/P18-QA-MANUAL-003/`؛ commit/build، command/cwd/exit، test report و Manual QA. هیچ secret/PII/PHI ثبت نشود.
