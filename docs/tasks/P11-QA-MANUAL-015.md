# P11-QA-MANUAL-015 — API 24، میانی، 36؛ small/normal/tablet/low-memory
...
- Status: TODO
- Phase/Area/Type: P11 / QA / MANUAL
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: HUMAN
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P11-QA-AUTO-014
- Blocks: P11-QA-MANUAL-016
- Requirement source: Master checklist row P11-QA-MANUAL-015 و Source audit بخش QA

## هدف قابل اندازه‌گیری
API 24، میانی، 36؛ small/normal/tablet/low-memory

## خروجی مورد انتظار
install/upgrade/rotation/background/network
...
- معیار اختصاصی: install/upgrade/rotation/background/network
...
- انتظار: install/upgrade/rotation/background/network
...
## Evidence
- مسیر: docs/evidence/P11-QA-MANUAL-015/
