# P06-SECURITY-CODE-007 — secret encryption/masking/rotation؛ key خارج DB
...
- Phase/Area/Type: P06 / SECURITY / CODE
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P06-MESSAGE-CODE-006
- Blocks: P06-SECURITY-SEC-008
- Requirement source: Master checklist row P06-SECURITY-CODE-007 و Source audit بخش SECURITY

## هدف قابل اندازه‌گیری
secret encryption/masking/rotation؛ key خارج DB

## خروجی مورد انتظار
REST/export/backup عمومی secret ندارد
...
- Dependencyها: P06-MESSAGE-CODE-006
...
- معیار اختصاصی: REST/export/backup عمومی secret ندارد
...
- انتظار: REST/export/backup عمومی secret ندارد
...
## Evidence
- مسیر: docs/evidence/P06-SECURITY-CODE-007/
...
## Completion record
- Started at: 2026-09-07T16:36:09
- Completed at: 2026-09-07T16:40:34
- Changed files: wordpress/packages/carmilla-core/inc/Settings/MessageSettings.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P06-SECURITY-CODE-007/summary.md
