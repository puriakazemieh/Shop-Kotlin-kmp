# P02-CORE-CODE-002 — versionهای hardcoded به Version Catalog موجود منتقل شوند
...
- Depends on: P02-CORE-DISC-001
- Blocks: P02-CORE-ADR-003
- Requirement source: Master checklist row P02-CORE-CODE-002 و Source audit بخش CORE

## هدف قابل اندازه‌گیری
versionهای hardcoded به Version Catalog موجود منتقل شوند

## خروجی مورد انتظار
build بدون تغییر dependency resolution؛ diff lockfile بررسی
...
- Dependencyها: P02-CORE-DISC-001
...
- معیار اختصاصی: build بدون تغییر dependency resolution؛ diff lockfile بررسی
...
- انتظار: build بدون تغییر dependency resolution؛ diff lockfile بررسی
...
## Evidence
- مسیر: docs/evidence/P02-CORE-CODE-002/
