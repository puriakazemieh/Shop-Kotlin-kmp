# P06-MESSAGE-CODE-011 — Action Scheduler queue، retry، dedupe و fallback
...
- Priority/Risk/Size: P1/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH
- Depends on: P06-MESSAGE-CODE-010
- Blocks: P06-MESSAGE-CODE-012
- Requirement source: Master checklist row P06-MESSAGE-CODE-011 و Source audit بخش MESSAGE

## هدف قابل اندازه‌گیری
Action Scheduler queue، retry، dedupe و fallback

## خروجی مورد انتظار
non-retryable retry نشود؛ duplicate کنترل
...
- Dependencyها: P06-MESSAGE-CODE-010
...
- معیار اختصاصی: non-retryable retry نشود؛ duplicate کنترل
...
- انتظار: non-retryable retry نشود؛ duplicate کنترل
...
## Evidence
- مسیر: docs/evidence/P06-MESSAGE-CODE-011/
...
## Completion record
- Started at: 2026-09-07T16:51:31
- Completed at: 2026-09-07T16:53:36
- Changed files: wordpress/carmilla-bridge/includes/class-cb-message-queue.php, wordpress/carmilla-bridge/includes/class-cb-plugin.php
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P06-MESSAGE-CODE-011/summary.md
