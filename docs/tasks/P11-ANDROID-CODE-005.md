# P11-ANDROID-CODE-005 — release build type، R8/shrink، baseline profile و mapping retention
...
- Status: TODO
- Phase/Area/Type: P11 / ANDROID / CODE
- Priority/Risk/Size: P0/MEDIUM / UNASSESSED (قبل از READY تعیین شود)
- Owner: AI
- Completion authority: BOTH
- Depends on: P11-ANDROID-SEC-004
- Blocks: P11-ANDROID-CODE-006
- Requirement source: Master checklist row P11-ANDROID-CODE-005 و Source audit بخش ANDROID

## هدف قابل اندازه‌گیری
release build type، R8/shrink، baseline profile و mapping retention

## خروجی مورد انتظار
signed AAB/APK install؛ crash symbol available
...
- Dependencyها: P11-ANDROID-SEC-004
...
- معیار اختصاصی: signed AAB/APK install؛ crash symbol available
...
- انتظار: signed AAB/APK install؛ crash symbol available
...
## Evidence
- مسیر: docs/evidence/P11-ANDROID-CODE-005/
