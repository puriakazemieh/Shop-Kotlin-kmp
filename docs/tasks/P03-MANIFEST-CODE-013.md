# P03-MANIFEST-CODE-013 — central route/deep-link guard
...
- Depends on: P03-MANIFEST-CODE-012
- Blocks: P03-MANIFEST-CODE-014
- Requirement source: Master checklist row P03-MANIFEST-CODE-013 و Source audit بخش MANIFEST

## هدف قابل اندازه‌گیری
central route/deep-link guard

## خروجی مورد انتظار
لینک مستقیم feature خاموش safe error/home
...
- Dependencyها: P03-MANIFEST-CODE-012
...
- معیار اختصاصی: لینک مستقیم feature خاموش safe error/home
...
- انتظار: لینک مستقیم feature خاموش safe error/home
...
## Evidence
- مسیر: docs/evidence/P03-MANIFEST-CODE-013/
