# CT-API-DOC-005 — ایجاد و نگه‌داری artifact: `docs/contracts/API_CONTRACT.md`
...
ایجاد و نگه‌داری artifact: `docs/contracts/API_CONTRACT.md`

## خروجی مورد انتظار
auth/error/paging/idempotency و نمونه redacted
...
- معیار اختصاصی: auth/error/paging/idempotency و نمونه redacted
...
- انتظار: auth/error/paging/idempotency و نمونه redacted
