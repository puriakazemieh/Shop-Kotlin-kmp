# CT-API-DOC-005 — قرارداد API مشترک دو backend و سه host WordPress
...
- Status: TODO
- Phase/Area/Type: CONTROL / API / DOC
...
- Requirement source: Master checklist row CT-API-DOC-005 و Source audit بخش API
...
docs/contracts/API_CONTRACT.md auth/error/paging/idempotency و نسخه API یکسان Theme-only/Plugin-only/both و provider Spring را با نمونه redacted نگه دارد.

## خروجی مورد انتظار
جدول endpoint/capability/owner و provider contract tests؛ تشخیص fixture از production؛ origin trusted و denial نمونه.
...
3. قرارداد/مستند این کارت را با موارد زیر تطبیق و تصمیم‌های باز را ownerدار ثبت کن: docs/contracts/API_CONTRACT.md auth/error/paging/idempotency و نسخه API یکسان Theme-only/Plugin-only/both و provider Spring را با نمونه redacted نگه دارد.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: جدول endpoint/capability/owner و provider contract tests؛ تشخیص fixture از production؛ origin trusted و denial نمونه.
...
- معیار اختصاصی: جدول endpoint/capability/owner و provider contract tests؛ تشخیص fixture از production؛ origin trusted و denial نمونه.
...
- معیار موفقیت: جدول endpoint/capability/owner و provider contract tests؛ تشخیص fixture از production؛ origin trusted و denial نمونه.
...
## Evidence
- مسیر: docs/evidence/CT-API-DOC-005/
