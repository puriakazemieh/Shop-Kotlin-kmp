# P00-QA-MANUAL-018 — exploratory baseline نسخه فعلی روی WordPress Theme/Plugin و targetهای قابل اجرای Android/Web/Desktop؛ iOS بدون محیط `BLOCKED` ثبت شود
...
- Blocks: P00-PROGRAM-GATE-019
- Requirement source: Master checklist row P00-QA-MANUAL-018 و Source audit بخش QA

## هدف قابل اندازه‌گیری
exploratory baseline نسخه فعلی روی WordPress Theme/Plugin و targetهای قابل اجرای Android/Web/Desktop؛ iOS بدون محیط `BLOCKED` ثبت شود

## خروجی مورد انتظار
tester/date/build/matrix، screenshot/video و defect inventory؛ در همین Task fix انجام نشود
...
- Dependencyها: P00-BUSINESS-BIZ-017
...
- معیار اختصاصی: tester/date/build/matrix، screenshot/video و defect inventory؛ در همین Task fix انجام نشود
...
- انتظار: tester/date/build/matrix، screenshot/video و defect inventory؛ در همین Task fix انجام نشود
...
## Evidence
- مسیر: docs/evidence/P00-QA-MANUAL-018/
