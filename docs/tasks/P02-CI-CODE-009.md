# P02-CI-CODE-009 — PR gate برای lint/unit/integration/package و artifact report
...
- Depends on: P02-QA-CODE-008
- Blocks: P02-CI-CODE-010
- Requirement source: Master checklist row P02-CI-CODE-009 و Source audit بخش CI

## هدف قابل اندازه‌گیری
PR gate برای lint/unit/integration/package و artifact report

## خروجی مورد انتظار
failure تست PR را fail کند؛ best-effort برای gate حیاتی ممنوع
...
- معیار اختصاصی: failure تست PR را fail کند؛ best-effort برای gate حیاتی ممنوع
...
- انتظار: failure تست PR را fail کند؛ best-effort برای gate حیاتی ممنوع
...
## Evidence
- مسیر: docs/evidence/P02-CI-CODE-009/
...
## Completion record
- Started at: 2026-08-26T10:50:00+03:30
- Completed at: 2026-08-26T10:52:00+03:30
- Changed files: .github/workflows/pr-gate.yml
- Commands and exit codes: .\gradlew.bat :composeApp:compileKotlinJvm (exit code 0)
- Manual tester/date/result: N/A
- Evidence paths: docs/evidence/P02-CI-CODE-009/EVIDENCE.md
