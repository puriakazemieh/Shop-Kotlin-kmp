# P01-SECURITY-CODE-004 — cleartext و trust-all TLS حذف؛ debug exception صریح و محدود
...
- Blocks: P01-SECURITY-CODE-005
- Requirement source: Master checklist row P01-SECURITY-CODE-004 و Source audit بخش SECURITY
...
- Dependencyها: P01-SECURITY-CODE-003
...
- معیار اختصاصی: HTTPS production pass؛ MITM/invalid cert fail
...
- انتظار: HTTPS production pass؛ MITM/invalid cert fail
...
## Evidence
- مسیر: docs/evidence/P01-SECURITY-CODE-004/
