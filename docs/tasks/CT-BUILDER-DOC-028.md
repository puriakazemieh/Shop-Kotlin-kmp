# CT-BUILDER-DOC-028 — هویت ساخت و provenance محصول و entitlement
...
- Status: TODO
- Phase/Area/Type: CONTROL / BUILDER / DOC
...
- Requirement source: Master checklist row CT-BUILDER-DOC-028 و Source audit بخش BUILDER
...
docs/delivery/CUSTOMER_BUILD_IDENTITY.md template/overlay/tenant/backend/SKU/target/signing/artifact fingerprint و منشأ Theme/Plugin/portal را پوشش دهد.

## خروجی مورد انتظار
دو برند و دو backend بدون fork؛ مجوز دامنه/build/target جدا؛ credential فقط reference و خارج WordPress.
...
3. قرارداد/مستند این کارت را با موارد زیر تطبیق و تصمیم‌های باز را ownerدار ثبت کن: docs/delivery/CUSTOMER_BUILD_IDENTITY.md template/overlay/tenant/backend/SKU/target/signing/artifact fingerprint و منشأ Theme/Plugin/portal را پوشش دهد.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: دو برند و دو backend بدون fork؛ مجوز دامنه/build/target جدا؛ credential فقط reference و خارج WordPress.
...
- معیار اختصاصی: دو برند و دو backend بدون fork؛ مجوز دامنه/build/target جدا؛ credential فقط reference و خارج WordPress.
...
- معیار موفقیت: دو برند و دو backend بدون fork؛ مجوز دامنه/build/target جدا؛ credential فقط reference و خارج WordPress.
...
## Evidence
- مسیر: docs/evidence/CT-BUILDER-DOC-028/
