# CT-BUILDER-DOC-028 — ایجاد و نگه‌داری artifact: `docs/delivery/CUSTOMER_BUILD_IDENTITY.md`
...
ایجاد و نگه‌داری artifact: `docs/delivery/CUSTOMER_BUILD_IDENTITY.md`

## خروجی مورد انتظار
template/overlay/tenant/signing/artifact fingerprint
...
- معیار اختصاصی: template/overlay/tenant/signing/artifact fingerprint
...
- انتظار: template/overlay/tenant/signing/artifact fingerprint
