# CT-SUPPORT-DOC-025 — ماتریس پشتیبانی محصول، میزبان، backend و target
...
- Requirement source: Master checklist row CT-SUPPORT-DOC-025 و Source audit بخش SUPPORT
...
docs/support/COMPATIBILITY_MATRIX.md نسخه WP/Woo/PHP/theme/kernel/API/OS/browser و SKU tested را به artifact evidence وصل کند.

## خروجی مورد انتظار
سه WordPress mode و دو backend؛ arbitrary theme هدف است ولی claim نسخه‌دار صرفاً برای آزموده‌ها؛ حالت unsupported روشن.
...
3. قرارداد/مستند این کارت را با موارد زیر تطبیق و تصمیم‌های باز را ownerدار ثبت کن: docs/support/COMPATIBILITY_MATRIX.md نسخه WP/Woo/PHP/theme/kernel/API/OS/browser و SKU tested را به artifact evidence وصل کند.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: سه WordPress mode و دو backend؛ arbitrary theme هدف است ولی claim نسخه‌دار صرفاً برای آزموده‌ها؛ حالت unsupported روشن.
...
- معیار اختصاصی: سه WordPress mode و دو backend؛ arbitrary theme هدف است ولی claim نسخه‌دار صرفاً برای آزموده‌ها؛ حالت unsupported روشن.
...
- معیار موفقیت: سه WordPress mode و دو backend؛ arbitrary theme هدف است ولی claim نسخه‌دار صرفاً برای آزموده‌ها؛ حالت unsupported روشن.
...
## Evidence
- مسیر: docs/evidence/CT-SUPPORT-DOC-025/
