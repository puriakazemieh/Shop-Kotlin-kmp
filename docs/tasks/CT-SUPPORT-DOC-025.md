# CT-SUPPORT-DOC-025 — ایجاد و نگه‌داری artifact: `docs/support/COMPATIBILITY_MATRIX.md`
...
ایجاد و نگه‌داری artifact: `docs/support/COMPATIBILITY_MATRIX.md`

## خروجی مورد انتظار
WP/Woo/PHP/OS/browser/device/backend versions
...
- معیار اختصاصی: WP/Woo/PHP/OS/browser/device/backend versions
...
- انتظار: WP/Woo/PHP/OS/browser/device/backend versions
