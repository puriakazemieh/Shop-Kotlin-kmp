# P05-QA-AUTO-021 — رگرسیون پرداخت در دو بسته مستقل و نصب هم‌زمان
...
- Status: TODO
- Phase/Area/Type: P05 / QA / AUTO
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: AI
- Completion authority: BOTH
- Depends on: P05-PAYMENT-CODE-020
- Blocks: P05-QA-MANUAL-022
- Requirement source: Master checklist row P05-QA-AUTO-021 و Source audit بخش QA
...
suite موجود مبلغ، callback، replay، refund و provider را روی Theme-only، Plugin-only با قالب ثالث و co-install اجرا کن؛ هر ترکیب SKU فقط providerهای Gate-passed را باز کند.

## خروجی مورد انتظار
گزارش ماتریس سه میزبان؛ duplicate callback/debit صفر؛ خاموشی فروش جدید مانع رسیدگی مجاز به سفارش قبلی نشود.
...
- Dependencyها: P05-PAYMENT-CODE-020
...
3. تغییر محدود این کارت را در مسیرهای مجاز پیاده یا آزمون کن: suite موجود مبلغ، callback، replay، refund و provider را روی Theme-only، Plugin-only با قالب ثالث و co-install اجرا کن؛ هر ترکیب SKU فقط providerهای Gate-passed را باز کند.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: گزارش ماتریس سه میزبان؛ duplicate callback/debit صفر؛ خاموشی فروش جدید مانع رسیدگی مجاز به سفارش قبلی نشود.
...
- معیار اختصاصی: گزارش ماتریس سه میزبان؛ duplicate callback/debit صفر؛ خاموشی فروش جدید مانع رسیدگی مجاز به سفارش قبلی نشود.
...
- معیار موفقیت: گزارش ماتریس سه میزبان؛ duplicate callback/debit صفر؛ خاموشی فروش جدید مانع رسیدگی مجاز به سفارش قبلی نشود.
...
## Evidence
- مسیر: docs/evidence/P05-QA-AUTO-021/
