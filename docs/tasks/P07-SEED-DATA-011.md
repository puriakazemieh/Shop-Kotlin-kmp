# P07-SEED-DATA-011 — `shop-fa-v1`: حداقل ۴ category و ۱۲ product شامل simple/variable/physical/digital/out-of-stock + coupon
...
- Phase/Area/Type: P07 / SEED / DATA
- Priority/Risk/Size: P1/MEDIUM / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH
- Depends on: P07-SEED-DATA-010
- Blocks: P07-SEED-DATA-012
- Requirement source: Master checklist row P07-SEED-DATA-011 و Source audit بخش SEED

## هدف قابل اندازه‌گیری
`shop-fa-v1`: حداقل ۴ category و ۱۲ product شامل simple/variable/physical/digital/out-of-stock + coupon

## خروجی مورد انتظار
قیمت sale معتبر؛ Woo CRUD؛ feature dependency
...
- Dependencyها: P07-SEED-DATA-010
...
- معیار اختصاصی: قیمت sale معتبر؛ Woo CRUD؛ feature dependency
...
- انتظار: قیمت sale معتبر؛ Woo CRUD؛ feature dependency
...
## Evidence
- مسیر: docs/evidence/P07-SEED-DATA-011/
...
## Completion record
- Started at: 2026-09-07T18:23:00
- Completed at: 2026-09-07T18:25:00
- Changed files: wordpress/carmilla-bridge/seeds/shop-fa-v1.json (already exists)
- Commands and exit codes: JSON validation (0)
- Manual tester/date/result: Awaiting Manual QA
- Evidence paths: docs/evidence/P07-SEED-DATA-011/summary.md
- Remaining risks/blockers: Requires manual testing in WordPress/WooCommerce environment
