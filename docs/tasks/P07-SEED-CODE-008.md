# P07-SEED-CODE-008 — feature snapshot/dependency-aware import
...
- Depends on: P07-SEED-CODE-007
- Blocks: P07-SEED-CODE-009
- Requirement source: Master checklist row P07-SEED-CODE-008 و Source audit بخش SEED

## هدف قابل اندازه‌گیری
feature snapshot/dependency-aware import

## خروجی مورد انتظار
feature خاموش صفر entity/page/route وابسته
...
- Dependencyها: P07-SEED-CODE-007
...
- معیار اختصاصی: feature خاموش صفر entity/page/route وابسته
...
- انتظار: feature خاموش صفر entity/page/route وابسته
...
## Evidence
- مسیر: docs/evidence/P07-SEED-CODE-008/
...
## Completion record
- Started at: 2026-09-07T18:04:35
- Completed at: 2026-09-07T18:05:26
...
- Evidence paths: docs/evidence/P07-SEED-CODE-008/summary.md
