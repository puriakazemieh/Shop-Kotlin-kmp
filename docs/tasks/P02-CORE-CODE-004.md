# P02-CORE-CODE-004 — `build-logic` و اولین convention plugin برای KMP library ساخته شود
...
- Depends on: P02-CORE-ADR-003
- Blocks: P02-CORE-CODE-005
- Requirement source: Master checklist row P02-CORE-CODE-004 و Source audit بخش CORE

## هدف قابل اندازه‌گیری
`build-logic` و اولین convention plugin برای KMP library ساخته شود

## خروجی مورد انتظار
دو ماژول pilot build؛ سپس rollout taskهای کوچک
...
- معیار اختصاصی: دو ماژول pilot build؛ سپس rollout taskهای کوچک
...
- انتظار: دو ماژول pilot build؛ سپس rollout taskهای کوچک
...
## Evidence
- مسیر: docs/evidence/P02-CORE-CODE-004/
