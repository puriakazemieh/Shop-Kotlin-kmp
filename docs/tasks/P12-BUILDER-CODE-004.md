# P12-BUILDER-CODE-004 — wizard ساخت با target و قابلیت‌های واقعاً خریداری‌شده
...
- Status: TODO
- Phase/Area/Type: P12 / BUILDER / CODE
- Priority/Risk/Size: P0/MEDIUM / UNASSESSED (قبل از READY تعیین شود)
- Owner: AI
- Completion authority: BOTH
- Depends on: P12-BUILDER-CODE-003
- Blocks: P12-BUILDER-CODE-005
- Requirement source: Master checklist row P12-BUILDER-CODE-004 و Source audit بخش BUILDER
...
wizard برند/هویت/دامنه/فروشگاه از هر host مستقل و رابط پروژه ارائه شود؛ target یا feature غایب/غیرمجاز پیش از enqueue رد شود.

## خروجی مورد انتظار
preview BuildSpec و هزینه/اعتبار؛ وضعیت آزمایشی یا آماده ساخت صادقانه؛ iOS/Desktop تا runner و Gate مربوط آماده تحویل نشان داده نشوند.
...
- Dependencyها: P12-BUILDER-CODE-003
...
3. تغییر محدود این کارت را در مسیرهای مجاز پیاده یا آزمون کن: wizard برند/هویت/دامنه/فروشگاه از هر host مستقل و رابط پروژه ارائه شود؛ target یا feature غایب/غیرمجاز پیش از enqueue رد شود.
4. معیار اختصاصی را با Evidence قابل بازتولید بررسی کن: preview BuildSpec و هزینه/اعتبار؛ وضعیت آزمایشی یا آماده ساخت صادقانه؛ iOS/Desktop تا runner و Gate مربوط آماده تحویل نشان داده نشوند.
...
- معیار اختصاصی: preview BuildSpec و هزینه/اعتبار؛ وضعیت آزمایشی یا آماده ساخت صادقانه؛ iOS/Desktop تا runner و Gate مربوط آماده تحویل نشان داده نشوند.
...
- معیار موفقیت: preview BuildSpec و هزینه/اعتبار؛ وضعیت آزمایشی یا آماده ساخت صادقانه؛ iOS/Desktop تا runner و Gate مربوط آماده تحویل نشان داده نشوند.
...
## Evidence
- مسیر: docs/evidence/P12-BUILDER-CODE-004/
