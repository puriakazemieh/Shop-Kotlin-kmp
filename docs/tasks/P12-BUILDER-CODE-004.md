# P12-BUILDER-CODE-004 — wizard branding/feature/package/domain/store metadata
...
wizard branding/feature/package/domain/store metadata

## خروجی مورد انتظار
validation قبل enqueue
...
- معیار اختصاصی: validation قبل enqueue
