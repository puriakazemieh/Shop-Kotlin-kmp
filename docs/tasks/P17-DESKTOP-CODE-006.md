# P17-DESKTOP-CODE-006 — deep link/single-instance/payment callback
...
- Depends on: P17-DESKTOP-SEC-005
- Blocks: P17-DESKTOP-CODE-007
- Requirement source: Master checklist row P17-DESKTOP-CODE-006 و Source audit بخش DESKTOP

## هدف قابل اندازه‌گیری
deep link/single-instance/payment callback

## خروجی مورد انتظار
malicious URI و cold/warm tests
...
- Dependencyها: P17-DESKTOP-SEC-005
...
- معیار اختصاصی: malicious URI و cold/warm tests
...
- انتظار: malicious URI و cold/warm tests
...
## Evidence
- مسیر: docs/evidence/P17-DESKTOP-CODE-006/
