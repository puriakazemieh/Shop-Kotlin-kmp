# P17-QA-MANUAL-015 — RTL،keyboard-only،screen reader،DPIهای مختلف
...
- Depends on: P17-QA-MANUAL-014
- Blocks: P17-DESKTOP-OPS-016
- Requirement source: Master checklist row P17-QA-MANUAL-015 و Source audit بخش QA

## هدف قابل اندازه‌گیری
RTL،keyboard-only،screen reader،DPIهای مختلف
...
- Dependencyها: P17-QA-MANUAL-014
...
- معیار اختصاصی: accessibility checklist
...
- انتظار: accessibility checklist
...
## Evidence
- مسیر: docs/evidence/P17-QA-MANUAL-015/
