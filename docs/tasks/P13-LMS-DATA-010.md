# P13-LMS-DATA-010 — conflict policy برای progress چنددستگاهی
...
conflict policy برای progress چنددستگاهی

## خروجی مورد انتظار
duplicate/out-of-order update داده را عقب نبرد
...
- معیار اختصاصی: duplicate/out-of-order update داده را عقب نبرد
...
- انتظار: duplicate/out-of-order update داده را عقب نبرد
...
## Evidence
- مسیر: docs/evidence/P13-LMS-DATA-010/
