# P11-QA-AUTO-014 — unit/UI/deep-link/payment/process-death regression
...
- Status: TODO
- Phase/Area/Type: P11 / QA / AUTO
- Priority/Risk/Size: P0/MEDIUM / UNASSESSED (قبل از READY تعیین شود)
- Owner: AI
- Completion authority: BOTH
- Depends on: P11-ANDROID-OPS-013
- Blocks: P11-QA-MANUAL-015
- Requirement source: Master checklist row P11-QA-AUTO-014 و Source audit بخش QA

## هدف قابل اندازه‌گیری
unit/UI/deep-link/payment/process-death regression

## خروجی مورد انتظار
release build test، نه فقط debug
...
- Dependencyها: P11-ANDROID-OPS-013
...
- معیار اختصاصی: release build test، نه فقط debug
...
- انتظار: release build test، نه فقط debug
...
## Evidence
- مسیر: docs/evidence/P11-QA-AUTO-014/
