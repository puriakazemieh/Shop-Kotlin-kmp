# P12-BUILDER-CODE-012 — template/backend/plugin compatibility matrix
...
template/backend/plugin compatibility matrix

## خروجی مورد انتظار
incompatible version قبل build fail
...
- معیار اختصاصی: incompatible version قبل build fail
...
- انتظار: incompatible version قبل build fail
