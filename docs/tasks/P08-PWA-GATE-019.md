...
## خروجی مورد انتظار
install/update/security/perf/accessibility pass
...
- معیار اختصاصی: install/update/security/perf/accessibility pass
...
- انتظار: install/update/security/perf/accessibility pass
