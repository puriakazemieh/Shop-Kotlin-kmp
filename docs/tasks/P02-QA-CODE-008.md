# P02-QA-CODE-008 — Spring test profile یا Testcontainers مستقل شود
...
- Depends on: P02-QA-CODE-007
- Blocks: P02-CI-CODE-009
- Requirement source: Master checklist row P02-QA-CODE-008 و Source audit بخش QA

## هدف قابل اندازه‌گیری
Spring test profile یا Testcontainers مستقل شود

## خروجی مورد انتظار
context test بدون PostgreSQL دستی سبز؛ production config استفاده نشود
...
- معیار اختصاصی: context test بدون PostgreSQL دستی سبز؛ production config استفاده نشود
...
- انتظار: context test بدون PostgreSQL دستی سبز؛ production config استفاده نشود
...
## Evidence
- مسیر: docs/evidence/P02-QA-CODE-008/
