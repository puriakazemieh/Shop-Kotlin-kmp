# P07-MIGRATION-ADR-016 — Demo Import و Customer Migration به دو workflow جدا
...
- Phase/Area/Type: P07 / MIGRATION / ADR
- Priority/Risk/Size: P0/HIGH / UNASSESSED (قبل از READY تعیین شود)
- Owner: BOTH
- Completion authority: BOTH یا HUMAN طبق Evidence
- Depends on: P07-SEED-DATA-015
- Blocks: P07-MIGRATION-DATA-017
- Requirement source: Master checklist row P07-MIGRATION-ADR-016 و Source audit بخش MIGRATION

## هدف قابل اندازه‌گیری
Demo Import و Customer Migration به دو workflow جدا

## خروجی مورد انتظار
scope/consent/retention روشن
...
- Dependencyها: P07-SEED-DATA-015
...
- معیار اختصاصی: scope/consent/retention روشن
...
- انتظار: scope/consent/retention روشن
...
## Evidence
- مسیر: docs/evidence/P07-MIGRATION-ADR-016/
...
## Completion record
- Started at: 2026-09-08T10:08:19
- Completed at: 2026-09-08T10:08:50
- Changed files: docs/architecture/adr/ADR-011-MIGRATION-VS-SEED.md
- Commands and exit codes: PowerShell Out-File (0)
- Manual tester/date/result: AWAITING_MANUAL_QA
- Evidence paths: docs/evidence/P07-MIGRATION-ADR-016/summary.md
