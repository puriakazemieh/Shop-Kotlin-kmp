...
interface InteractionApi {
    ...
    suspend fun updateReview(reviewId: Long, request: CreateReviewRequestDto): ReviewResponse
    ...
    suspend fun updateQuestion(questionId: Long, request: CreateQuestionRequestDto): QuestionResponse
