...
object Resources {
    ...
    object String {
        ...
        val DiscountCode = CommonRes.string.discount_code
        val Apply = CommonRes.string.apply_label
        val Remove = CommonRes.string.remove_label
        val DiscountAmount = CommonRes.string.discount_amount
        ...
        val DiscountTypeLabel = CommonRes.string.discount_type_label
        val MaxDiscountAmountLabel = CommonRes.string.max_discount_amount_label
        val MinOrderAmountLabel = CommonRes.string.min_order_amount_label
        val StartDateLabel = CommonRes.string.start_date_label
        val EndDateLabel = CommonRes.string.end_date_label
        val UsageLimitLabel = CommonRes.string.usage_limit_label
        val IsActiveLabel = CommonRes.string.is_active_label
        val Percentage = CommonRes.string.percentage
        val FixedAmount = CommonRes.string.fixed_amount
